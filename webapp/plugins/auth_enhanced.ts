...
function setupNavigationGuards(
    ...
    router.beforeEach(async (to, from, next) => {
        ...
        const isPublicRoute = config.publicRoutes.includes(to.path) || to.meta?.public === true || to.meta?.requiresAuth === false;

        // Check authentication requirement
        const requiresAuth = (config.requireAuthByDefault && !isPublicRoute) || to.meta?.requiresAuth === true;
