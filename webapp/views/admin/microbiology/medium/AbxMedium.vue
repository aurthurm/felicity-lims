    ...
    <div class="overflow-x-auto">
      <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-card shadow-dashboard rounded-lg p-6">
        <Table class="min-w-full divide-y divide-border">
          ...
          <TableRow v-for="medium in abxMediums" :key="medium?.uid">
            <TableCell class="px-3 py-3.5 whitespace-nowrap text-sm text-foreground">{{ medium?.name }}</TableCell>
            <TableCell class="px-3 py-3.5 whitespace-nowrap text-sm text-foreground">{{ medium?.description }}</TableCell>
