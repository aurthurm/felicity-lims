      ...
      <div class="relative w-full overflow-auto">
        <Table class="w-full caption-bottom text-sm">
          ...
          <TableBody class="[&_tr:last-child]:border-0">
            <TableRow v-for="soi in abxSiteOfInfections" :key="soi?.uid" class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
              <TableCell class="px-4 py-3 align-middle whitespace-nowrap text-sm text-foreground">{{ soi?.name }}</TableCell>
              <TableCell class="px-4 py-3 align-middle whitespace-nowrap text-sm text-foreground">{{ soi?.description }}</TableCell>
