...
<template>
 <div class="space-y-6">
 <beak-heading title="Site of Infection"></beak-heading>
 ...
 <td class="whitespace-nowrap text-sm text-foreground">{{ soi?.name }}</td>
 <td class="whitespace-nowrap text-sm text-foreground">{{ soi?.description }}</td>
