...
<template>
 <div class="space-y-6">
 <beak-heading title="Antibiotic Host"></beak-heading>
 ...
 <td class="whitespace-nowrap text-sm text-foreground">{{ host?.name }}</td>
 <td class="whitespace-nowrap text-sm text-foreground">{{ host?.description }}</td>
