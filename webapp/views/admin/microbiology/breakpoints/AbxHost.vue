      ...
      <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-card shadow-dashboard rounded-lg p-6">
        <Table class="min-w-full divide-y divide-border">
          ...
          <TableBody class="bg-background divide-y divide-border">
            <TableRow v-for="host in abxHosts" :key="host?.uid">
              <TableCell class="px-3 py-3.5 whitespace-nowrap text-sm text-foreground">{{ host?.name }}</TableCell>
              <TableCell class="px-3 py-3.5 whitespace-nowrap text-sm text-foreground">{{ host?.description }}</TableCell>
