...
<template>
 ...
 <th class="text-left text-sm font-semibold text-foreground">Guidelines</th>
 <th class="text-left text-sm font-semibold text-foreground">Potency</th>
 <th class="text-left text-sm font-semibold text-foreground">LOINC MIC</th>
 <th class="text-left text-sm font-semibold text-foreground">LOINC DISK</th>
 <th class="text-left text-sm font-semibold text-foreground">LOINC ETEST</th>
 ...
 <td class="whitespace-nowrap text-sm text-foreground">{{ abx?.name }}</td>
 ...
 <td class="whitespace-nowrap text-sm text-foreground">{{ abx?.potency }}</td>
 <td class="whitespace-nowrap text-sm text-foreground">{{ abx?.loincmic }}</td>
 <td class="whitespace-nowrap text-sm text-foreground">{{ abx?.loincdisk }}</td>
 <td class="whitespace-nowrap text-sm text-foreground">{{ abx?.loincetest }}</td>
