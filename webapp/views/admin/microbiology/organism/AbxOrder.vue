...
<template>
 <div class="space-y-6">
 <beak-heading title="Orders">
 <beak-button @click="FormManager(true)">Add Order</beak-button>
 </beak-heading>
 ...
 <th class="text-left text-sm font-semibold text-foreground">Class</th>
 ...
 <td class="whitespace-nowrap text-sm text-foreground">{{ guideline?.class_?.name }}</td>
