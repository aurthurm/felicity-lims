        ...
        <Table class="min-w-full divide-y divide-border">
          <TableHeader>
            <TableRow>
              ...
              <TableHead class="px-3 py-3.5 text-left text-sm font-semibold text-foreground">Class</TableHead>
          ...
          <TableBody class="divide-y divide-border bg-background">
            <TableRow v-for="guideline in abxOrders" :key="guideline?.uid" class="hover:bg-muted/50">
              <TableCell class="whitespace-nowrap px-3 py-4 text-sm text-foreground">{{ guideline?.name }}</TableCell>
              <TableCell class="whitespace-nowrap px-3 py-4 text-sm text-foreground">{{ guideline?.class_?.name }}</TableCell>
