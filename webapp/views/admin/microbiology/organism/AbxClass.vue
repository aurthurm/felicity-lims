...
<template>
 <div class="space-y-6">
 <beak-heading title="Classes">
 <beak-button @click="FormManager(true)">Add Class</beak-button>
 </beak-heading>
 ...
 <th class="text-left text-sm font-semibold text-foreground">Phylum</th>
 ...
 <td class="whitespace-nowrap text-sm text-foreground">{{ guideline?.phylum?.name }}</td>
