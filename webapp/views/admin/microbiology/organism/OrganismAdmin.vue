...
const tabs = computed(() => [
  {
    id: "abx-organism", label: "organism",
    component: defineAsyncComponent(() => import("./AbxOrganism.vue")),
  },
  {
    id: "abx-organism-serotype", label: "organism-serotype",
...
<template>
  <BeakTabs :tabs="tabs" initial-tab="abx-organism"/>
</template>
