        ...
        <Table class="w-full caption-bottom text-sm">
          <TableHeader class="[&_tr]:border-b">
            <TableRow class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
              ...
              <TableHead class="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Kingdom</TableHead>
          ...
          <TableBody class="[&_tr:last-child]:border-0">
            <TableRow v-for="guideline in abxPhylums" :key="guideline?.uid" class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
              <TableCell class="px-4 py-3 align-middle whitespace-nowrap text-sm text-foreground">{{ guideline?.name }}</TableCell>
              <TableCell class="px-4 py-3 align-middle whitespace-nowrap text-sm text-foreground">{{ guideline?.kingdom?.name }}</TableCell>
