...
const Samples = defineAsyncComponent(
...
<template>
  <div>
    <beak-heading title="Samples" class="flex-1" >
      <router-link
          v-show="shield.hasRights(shield.actions.CREATE, shield.objects.SAMPLE)" to="/patients/search"
