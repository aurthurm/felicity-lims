...
export function useGetAllCountriesQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllCountriesQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllCountriesQuery, GetAllCountriesQueryVariables | undefined>({ query: GetAllCountriesDocument, variables: undefined, ...options });
};
...
export function useGetAllProvincesQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllProvincesQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllProvincesQuery, GetAllProvincesQueryVariables | undefined>({ query: GetAllProvincesDocument, variables: undefined, ...options });
};
...
export function useFilterProvincesByCountryQuery(options?: Omit<Urql.UseQueryArgs<never, FilterProvincesByCountryQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<FilterProvincesByCountryQuery, FilterProvincesByCountryQueryVariables | undefined>({ query: FilterProvincesByCountryDocument, variables: undefined, ...options });
};
...
export function useGetAllDistrictsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllDistrictsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllDistrictsQuery, GetAllDistrictsQueryVariables | undefined>({ query: GetAllDistrictsDocument, variables: undefined, ...options });
};
...
export function useFilterDistrictsByProvinceQuery(options?: Omit<Urql.UseQueryArgs<never, FilterDistrictsByProvinceQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<FilterDistrictsByProvinceQuery, FilterDistrictsByProvinceQueryVariables | undefined>({ query: FilterDistrictsByProvinceDocument, variables: undefined, ...options });
};