...
export type AddStoreRoomMutation = { __typename?: 'Mutation' } & {
    createStoreRoom:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StoreRoomType' } & Pick<Types.StoreRoomType, 'uid' | 'name' | 'description'>);
};
...
export type EditStoreRoomMutation = { __typename?: 'Mutation' } & {
    updateStoreRoom:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StoreRoomType' } & Pick<Types.StoreRoomType, 'uid' | 'name' | 'description'>);
};
...
export type AddStorageLocationMutation = { __typename?: 'Mutation' } & {
...
export type EditStorageLocationMutation = { __typename?: 'Mutation' } & {
    ...
    createStorageSection:
        ...
        | ({ __typename: 'StorageSectionType' } & Pick<Types.StorageSectionType, 'uid' | 'name' | 'description' | 'storageLocationUid'> & {
                  storageLocation?: Types.Maybe<
                      { __typename?: 'StorageLocationType' } & Pick<Types.StorageLocationType, 'uid' | 'storeRoomUid'>
                  >;
              });
};
...
export type AddStorageContainerMutation = { __typename?: 'Mutation' } & {
        ...
        | ({ __typename: 'StorageContainerType' } & Pick<
          ...
          > & {
                  storageSection?: Types.Maybe<
                      { __typename?: 'StorageSectionType' } & Pick<Types.StorageSectionType, 'uid' | 'storageLocationUid'> & {
                              storageLocation?: Types.Maybe<
                                  { __typename?: 'StorageLocationType' } & Pick<Types.StorageLocationType, 'uid' | 'storeRoomUid'>
                              >;
                          }
...
export type StoreSamplesMutation = { __typename?: 'Mutation' } & {
    storeSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StoredSamplesType' } & {
              samples: Array<
                  { __typename?: 'SampleType' } & Pick<
                      Types.SampleType,
                      'uid' | 'sampleId' | 'priority' | 'status' | 'storageSlot' | 'storageContainerUid'
                  >
              >;
          });
};
...
export type RecoverSamplesMutation = { __typename?: 'Mutation' } & {
    recoverSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StoredSamplesType' } & {
              samples: Array<
                  { __typename?: 'SampleType' } & Pick<Types.SampleType, 'uid' | 'status' | 'storageSlot' | 'storageContainerUid'>
              >;
          });
};
