...
export function useGetNoticesByCreatorUidQuery(options?: Omit<Urql.UseQueryArgs<never, GetNoticesByCreatorUidQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetNoticesByCreatorUidQuery, GetNoticesByCreatorUidQueryVariables | undefined>({ query: GetNoticesByCreatorUidDocument, variables: undefined, ...options });
};