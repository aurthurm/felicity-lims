...
export type AddDocumentFolderMutation = { __typename?: 'Mutation' } & {
    createDocumentFolder:
        | ({ __typename?: 'DocumentFolderType' } & Pick<Types.DocumentFolderType, 'uid' | 'name' | 'parentUid'>)
        ...
        | ({ __typename?: 'DocumentType' } & Pick<
          ...
          > & {
                  latestVersion?: Types.Maybe<
                      { __typename?: 'DocumentVersionType' } & Pick<Types.DocumentVersionType, 'uid' | 'content' | 'editor' | 'thumbnail'>
                  >;
...
export type EditDocumentVersionMutation = { __typename?: 'Mutation' } & {
    updateDocumentVersion:
        | ({ __typename?: 'DocumentVersionType' } & Pick<Types.DocumentVersionType, 'uid' | 'thumbnail'>)
        | ({ __typename?: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
