    ...
    createWorksheetTemplate:
        ...
        | ({ __typename: 'WorkSheetTemplateType' } & Pick<
          ...
          > & {
                  ...
                  >;
                  qcLevels?: Types.Maybe<Array<{ __typename?: 'QCLevelType' } & Pick<Types.QcLevelType, 'uid' | 'level'>>>;
...
export type AddWorkSheetMutation = { __typename?: 'Mutation' } & {
    createWorksheet:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'WorksheetListingType' } & {
              worksheets?: Types.Maybe<
                  Array<
...
export type UpdateWorkSheetMutation = { __typename?: 'Mutation' } & {
    updateWorksheet:
        ...
        | ({ __typename: 'WorkSheetType' } & Pick<
              Types.WorkSheetType,
              'uid' | 'numberOfSamples' | 'sampleTypeUid' | 'instrumentUid' | 'templateUid'
          > & {
...
export type EditWorkSheetApplyTemplateMutation = { __typename?: 'Mutation' } & {
...
export type ManualyAssignWorsheetMutation = { __typename?: 'Mutation' } & {
...
export type ActionAssignWorsheetMutation = { __typename?: 'Mutation' } & {
    actionWorksheets:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'WorksheetListingType' } & {
              worksheets?: Types.Maybe<Array<{ __typename?: 'WorkSheetType' } & Pick<Types.WorkSheetType, 'uid' | 'state'>>>;
          });
};
...
export function useEditWorkSheetApplyTemplateMutation() {
    return Urql.useMutation<EditWorkSheetApplyTemplateMutation, EditWorkSheetApplyTemplateMutationVariables>(
