...
export type AddHazardMutation = { __typename?: 'Mutation' } & {
    createHazard:
        | ({ __typename: 'HazardType' } & Pick<Types.HazardType, 'uid' | 'name' | 'description'>)
...
export type EditHazardMutation = { __typename?: 'Mutation' } & {
    updateHazard:
        | ({ __typename: 'HazardType' } & Pick<Types.HazardType, 'uid' | 'name' | 'description'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type AddStockCategoryMutation = { __typename?: 'Mutation' } & {
    createStockCategory:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockCategoryType' } & Pick<Types.StockCategoryType, 'uid' | 'name' | 'description'>);
};
...
export type EditStockCategoryMutation = { __typename?: 'Mutation' } & {
    updateStockCategory:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockCategoryType' } & Pick<Types.StockCategoryType, 'uid' | 'name' | 'description'>);
};
...
export type AddStockUnitMutation = { __typename?: 'Mutation' } & {
    createStockUnit:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockUnitType' } & Pick<Types.StockUnitType, 'uid' | 'name'>);
};
...
export type EditStockUnitMutation = { __typename?: 'Mutation' } & {
    updateStockUnit:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockUnitType' } & Pick<Types.StockUnitType, 'uid' | 'name'>);
};
...
export type ReceiveStockProductMutation = { __typename?: 'Mutation' } & {
    createStockReceipt:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockItemVariantType' } & Pick<Types.StockItemVariantType, 'uid' | 'name' | 'description' | 'quantity'> & {
                  stockItem?: Types.Maybe<
                      { __typename?: 'StockItemType' } & Pick<Types.StockItemType, 'name' | 'description'> & {
                              category?: Types.Maybe<{ __typename?: 'StockCategoryType' } & Pick<Types.StockCategoryType, 'name'>>;
...
export type AddStockItemMutation = { __typename?: 'Mutation' } & {
    createStockItem:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockItemType' } & Pick<Types.StockItemType, 'uid' | 'name' | 'description'>);
};
...
export type EditStockItemMutation = { __typename?: 'Mutation' } & {
    updateStockItem:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockItemType' } & Pick<Types.StockItemType, 'uid' | 'name' | 'description'>);
};
...
export type AddStockItemVariantMutation = { __typename?: 'Mutation' } & {
    createStockItemVariant:
        ...
        | ({ __typename: 'StockItemVariantType' } & Pick<
              ...
              'uid' | 'name' | 'description' | 'stockItemUid' | 'minimumLevel' | 'maximumLevel' | 'createdAt'
...
export type EditStockItemVariantMutation = { __typename?: 'Mutation' } & {
    updateStockItemVariant:
        ...
        | ({ __typename: 'StockItemVariantType' } & Pick<
              Types.StockItemVariantType,
              'uid' | 'name' | 'description' | 'stockItemUid' | 'minimumLevel' | 'maximumLevel' | 'createdAt' | 'updatedAt'
          > & {
                  createdBy?: Types.Maybe<{ __typename?: 'UserType' } & Pick<Types.UserType, 'uid' | 'firstName' | 'lastName'>>;
...
export type AddStockOrderMutation = { __typename?: 'Mutation' } & {
    createStockOrder:
        ...
        | ({ __typename: 'StockOrderLineType' } & {
              stockOrder: { __typename?: 'StockOrderType' } & Pick<
                  Types.StockOrderType,
                  'uid' | 'orderByUid' | 'departmentUid' | 'status' | 'orderNumber'
              >;
              orderProducts: Array<
                  { __typename?: 'StockOrderProductType' } & Pick<
                      Types.StockOrderProductType,
                      'uid' | 'productUid' | 'orderUid' | 'quantity'
                  >
              >;
          })
...
export type EditStockOrderMutation = { __typename?: 'Mutation' } & {
    updateStockOrder:
        ...
        | ({ __typename: 'StockOrderLineType' } & {
              stockOrder: { __typename?: 'StockOrderType' } & Pick<
                  Types.StockOrderType,
                  'uid' | 'orderByUid' | 'departmentUid' | 'status' | 'orderNumber' | 'remarks'
              >;
              orderProducts: Array<
                  { __typename?: 'StockOrderProductType' } & Pick<
                      Types.StockOrderProductType,
...
export type SubmitStockOrderMutation = { __typename?: 'Mutation' } & {
    submitStockOrder:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename?: 'StockOrderLineType' }
...
export type ApproveStockOrderMutation = { __typename?: 'Mutation' } & {
    approveStockOrder:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename?: 'StockOrderLineType' }
        | ({ __typename: 'StockOrderType' } & Pick<
              Types.StockOrderType,
              'uid' | 'orderByUid' | 'departmentUid' | 'status' | 'orderNumber' | 'remarks'
          >);
};
...
export type IssueStockOrderMutation = { __typename?: 'Mutation' } & {
    issueStockOrder:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'StockOrderLineType' } & {
              stockOrder: { __typename?: 'StockOrderType' } & Pick<
              ...
              >;
              orderProducts: Array<
                  { __typename?: 'StockOrderProductType' } & Pick<Types.StockOrderProductType, 'uid' | 'orderUid' | 'quantity'> & {
                          product?: Types.Maybe<
                              { __typename?: 'StockItemVariantType' } & Pick<Types.StockItemVariantType, 'uid' | 'quantity'>
                          >;
                      }
              >;
          })
...
export type DeleteStockOrderMutation = { __typename?: 'Mutation' } & {
    deleteStockOrder:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename: 'StockOrderLineType' }
        | { __typename?: 'StockOrderType' };
