...
export type GetOrganizationQuery = { __typename?: 'Query' } & {
    organization: { __typename?: 'OrganizationType' } & Pick<
        ...
        | 'qualityStatement'
    > & {
            settings: { __typename?: 'OrganizationSettingType' } & Pick<
...
export type GetLaboratoryQuery = { __typename?: 'Query' } & {
    laboratory: { __typename?: 'LaboratoryType' } & Pick<
    ...
    > & {
            settings?: Types.Maybe<
                { __typename?: 'LaboratorySettingType' } & Pick<
...
export type GetAllLaboratoriesQuery = { __typename?: 'Query' } & {
    laboratoryAll: { __typename?: 'LaboratoryCursorPage' } & Pick<Types.LaboratoryCursorPage, 'totalCount'> & {
            pageInfo: { __typename?: 'PageInfo' } & Pick<Types.PageInfo, 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | 'endCursor'>;
            items?: Types.Maybe<
                Array<
                    { __typename?: 'LaboratoryType' } & Pick<
                        Types.LaboratoryType,
                        | 'uid'
                        | 'name'
                        | 'tagLine'
...
export type UserAllQuery = { __typename?: 'Query' } & {
    userAll: { __typename?: 'UserCursorPage' } & Pick<Types.UserCursorPage, 'totalCount'> & {
            pageInfo: { __typename?: 'PageInfo' } & Pick<Types.PageInfo, 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | 'endCursor'>;
            items?: Types.Maybe<
                Array<
                    ...
                    > & {
                            groups?: Types.Maybe<
                                Array<
                                    { __typename?: 'GroupType' } & Pick<Types.GroupType, 'uid' | 'name' | 'keyword' | 'pages'> & {
                                            permissions?: Types.Maybe<
                                                Array<
                                                    { __typename?: 'PermissionType' } & Pick<
...
export type GroupsAndPermissionsQuery = { __typename?: 'Query' } & {
    groupAll: Array<
        { __typename?: 'GroupType' } & Pick<Types.GroupType, 'uid' | 'name' | 'keyword' | 'pages' | 'active'> & {
                permissions?: Types.Maybe<
                    Array<{ __typename?: 'PermissionType' } & Pick<Types.PermissionType, 'uid' | 'action' | 'target'>>
                >;
            }
    >;
    permissionAll: Array<{ __typename?: 'PermissionType' } & Pick<Types.PermissionType, 'uid' | 'action' | 'target'>>;
};
...
export type GetAuditLogsQuery = { __typename?: 'Query' } & {
    auditLogsFilter?: Types.Maybe<
        Array<
            { __typename?: 'AuditLogType' } & Pick<
                Types.AuditLogType,
                'uid' | 'userUid' | 'targetType' | 'targetUid' | 'action' | 'stateBefore' | 'stateAfter' | 'extras'
            >
        >
    >;
};
...
export type GetAllDepartmentsQuery = { __typename?: 'Query' } & {
    departmentAll: Array<{ __typename?: 'DepartmentType' } & Pick<Types.DepartmentType, 'uid' | 'name' | 'code' | 'description'>>;
};
...
export type GetUserPreferencesQuery = { __typename?: 'Query' } & {
    userPreferences: { __typename?: 'UserPreferenceType' } & Pick<
        Types.UserPreferenceType,
        'uid' | 'expandedMenu' | 'theme' | 'defaultRoute'
    > & { departments?: Types.Maybe<Array<{ __typename?: 'DepartmentType' } & Pick<Types.DepartmentType, 'uid' | 'name'>>> };
};
...
export function useGetOrganizationQuery(options?: Omit<Urql.UseQueryArgs<never, GetOrganizationQueryVariables | undefined>, 'query'>) {
    return Urql.useQuery<GetOrganizationQuery, GetOrganizationQueryVariables | undefined>({
...
export function useGetLaboratoryQuery(options?: Omit<Urql.UseQueryArgs<never, GetLaboratoryQueryVariables | undefined>, 'query'>) {
    return Urql.useQuery<GetLaboratoryQuery, GetLaboratoryQueryVariables | undefined>({
        query: GetLaboratoryDocument,
        variables: undefined,
        ...options,
    });
}
...
export function useGetAllLaboratoriesQuery(
    options?: Omit<Urql.UseQueryArgs<never, GetAllLaboratoriesQueryVariables | undefined>, 'query'>,
) {
    return Urql.useQuery<GetAllLaboratoriesQuery, GetAllLaboratoriesQueryVariables | undefined>({
        query: GetAllLaboratoriesDocument,
        variables: undefined,
        ...options,
    });
}
...
export function useGroupsAndPermissionsQuery(
    options?: Omit<Urql.UseQueryArgs<never, GroupsAndPermissionsQueryVariables | undefined>, 'query'>,
) {
    return Urql.useQuery<GroupsAndPermissionsQuery, GroupsAndPermissionsQueryVariables | undefined>({
        query: GroupsAndPermissionsDocument,
        variables: undefined,
        ...options,
    });
}
...
export function useGetAuditLogsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAuditLogsQueryVariables | undefined>, 'query'>) {
    return Urql.useQuery<GetAuditLogsQuery, GetAuditLogsQueryVariables | undefined>({
...
export function useGetAllDepartmentsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllDepartmentsQueryVariables | undefined>, 'query'>) {
    return Urql.useQuery<GetAllDepartmentsQuery, GetAllDepartmentsQueryVariables | undefined>({
...
export function useGetUserPreferencesQuery(
    options?: Omit<Urql.UseQueryArgs<never, GetUserPreferencesQueryVariables | undefined>, 'query'>,
) {
    return Urql.useQuery<GetUserPreferencesQuery, GetUserPreferencesQueryVariables | undefined>({
