...
export type EditProfilePricingMutation = { __typename?: 'Mutation' } & {
    updateProfilePrice:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ProfilePriceType' } & Pick<Types.ProfilePriceType, 'uid' | 'isActive' | 'amount'>);
};
...
export type EditAnalysisPricingMutation = { __typename?: 'Mutation' } & {
    updateAnalysisPrice:
        | ({ __typename: 'AnalysisPriceType' } & Pick<Types.AnalysisPriceType, 'uid' | 'isActive' | 'amount'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditVoucherCodeMutation = { __typename?: 'Mutation' } & {
    updateVoucherCode:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'VoucherCodeType' } & Pick<
              Types.VoucherCodeType,
...
export type ConfirmTestBillTransactionMutation = { __typename?: 'Mutation' } & {
...
export function useConfirmTestBillTransactionMutation() {
    return Urql.useMutation<ConfirmTestBillTransactionMutation, ConfirmTestBillTransactionMutationVariables>(
        ConfirmTestBillTransactionDocument
    );
}
