...
export type AuthenticateUserMutation = { __typename?: 'Mutation' } & {
    authenticateUser:
        | ({ __typename: 'AuthenticatedData' } & Pick<Types.AuthenticatedData, 'token' | 'refresh' | 'tokenType'> & {
                  user: { __typename?: 'UserType' } & Pick<Types.UserType, 'uid' | 'firstName' | 'lastName'> & {
                          groups?: Types.Maybe<
                              Array<
                          ...
                          preference?: Types.Maybe<
                              { __typename?: 'UserPreferenceType' } & Pick<Types.UserPreferenceType, 'uid' | 'expandedMenu' | 'theme'> & {
                                      departments?: Types.Maybe<
                                          Array<{ __typename?: 'DepartmentType' } & Pick<Types.DepartmentType, 'uid' | 'name'>>
                                      >;
                                  }
                          >;
                      };
                  laboratories?: Types.Maybe<Array<{ __typename?: 'LaboratoryType' } & Pick<Types.LaboratoryType, 'uid' | 'name'>>>;
                  activeLaboratory?: Types.Maybe<{ __typename?: 'LaboratoryType' } & Pick<Types.LaboratoryType, 'uid' | 'name'>>;
              })
...
export type RequestPassResetMutation = { __typename?: 'Mutation' } & {
    requestPasswordReset:
        | ({ __typename: 'MessagesType' } & Pick<Types.MessagesType, 'message'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type ValidatePassResetTokenMutation = { __typename?: 'Mutation' } & {
    validatePasswordResetToken:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'PasswordResetValidityType' } & Pick<Types.PasswordResetValidityType, 'username'>);
};
...
export type SwitchActiveLaboratoryMutation = { __typename?: 'Mutation' } & {
    setUserActiveLaboratory:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'UserType' } & Pick<Types.UserType, 'activeLaboratoryUid' | 'laboratories'>);
};
...
export type AddGroupMutation = { __typename?: 'Mutation' } & {
    createGroup:
        | ({ __typename: 'GroupType' } & Pick<Types.GroupType, 'uid' | 'name' | 'pages' | 'active'> & {
                  permissions?: Types.Maybe<
                      Array<{ __typename?: 'PermissionType' } & Pick<Types.PermissionType, 'uid' | 'action' | 'target' | 'active'>>
                  >;
              })
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type UpdateGroupsAndPermissionsMutation = { __typename?: 'Mutation' } & {
    updateGroupPermissions:
        ...
        | ({ __typename?: 'UpdatedGroupPerms' } & {
              group: { __typename?: 'GroupType' } & Pick<Types.GroupType, 'uid' | 'name' | 'pages' | 'active'> & {
                      permissions?: Types.Maybe<
                          Array<{ __typename?: 'PermissionType' } & Pick<Types.PermissionType, 'uid' | 'action' | 'target' | 'active'>>
                      >;
                  };
              permission: { __typename?: 'PermissionType' } & Pick<Types.PermissionType, 'uid' | 'action' | 'target'>;
          });
};
...
export type AddDepartmentMutation = { __typename?: 'Mutation' } & {
    createDepartment:
        | ({ __typename?: 'DepartmentType' } & Pick<Types.DepartmentType, 'uid' | 'name'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditOrganizationSettingMutation = { __typename?: 'Mutation' } & {
    updateOrganizationSetting:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'OrganizationSettingType' } & Pick<
...
export type EditUserPreferencesMutationVariables = Types.Exact<{
    preferencesIn: Types.UserPreferenceInput;
}>;

export type EditUserPreferencesMutation = { __typename?: 'Mutation' } & {
    updateUserPreferences:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'UserPreferenceType' } & Pick<Types.UserPreferenceType, 'uid' | 'expandedMenu' | 'theme' | 'defaultRoute'> & {
...
export function useUpdateGroupsAndPermissionsMutation() {
    return Urql.useMutation<UpdateGroupsAndPermissionsMutation, UpdateGroupsAndPermissionsMutationVariables>(
        UpdateGroupsAndPermissionsDocument,
    );
}
...
export const EditUserPreferencesDocument = gql`
    mutation EditUserPreferences($preferencesIn: UserPreferenceInput!) {
        updateUserPreferences(preferencesIn: $preferencesIn) {
...
export function useEditUserPreferencesMutation() {
    return Urql.useMutation<EditUserPreferencesMutation, EditUserPreferencesMutationVariables>(EditUserPreferencesDocument);
}
