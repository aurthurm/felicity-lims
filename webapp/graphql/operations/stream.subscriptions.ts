...
export function useGetSystemActivitySubscription<R = GetSystemActivitySubscription>(options?: Omit<Urql.UseSubscriptionArgs<never, GetSystemActivitySubscriptionVariables | undefined>, 'query'>, handler?: Urql.SubscriptionHandlerArg<GetSystemActivitySubscription, R>) {
  return Urql.useSubscription<GetSystemActivitySubscription, R, GetSystemActivitySubscriptionVariables | undefined>({ query: GetSystemActivityDocument, variables: undefined, ...options }, handler);
};