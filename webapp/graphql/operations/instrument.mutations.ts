...
export type AddSupplierMutation = { __typename?: 'Mutation' } & {
    createSupplier:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'SupplierType' } & Pick<Types.SupplierType, 'uid' | 'name' | 'description'>);
};
...
export type EditSupplierMutation = { __typename?: 'Mutation' } & {
    updateSupplier:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'SupplierType' } & Pick<Types.SupplierType, 'uid' | 'name' | 'description'>);
};
...
export type AddManufacturerMutation = { __typename?: 'Mutation' } & {
    createManufacturer:
        | ({ __typename?: 'ManufacturerType' } & Pick<Types.ManufacturerType, 'uid' | 'name' | 'description'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditManufacturerMutation = { __typename?: 'Mutation' } & {
    updateManufacturer:
        | ({ __typename?: 'ManufacturerType' } & Pick<Types.ManufacturerType, 'uid' | 'name' | 'description'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type AddInstrumentTypeMutation = { __typename?: 'Mutation' } & {
    createInstrumentType:
        | ({ __typename?: 'InstrumentTypeType' } & Pick<Types.InstrumentTypeType, 'uid' | 'name' | 'description'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditInstrumentTypeMutation = { __typename?: 'Mutation' } & {
...
export type AddInstrumentMutation = { __typename?: 'Mutation' } & {
    createInstrument:
        | ({ __typename?: 'InstrumentType' } & Pick<Types.InstrumentType, 'uid' | 'name' | 'description' | 'keyword'> & {
                  instrumentType?: Types.Maybe<{ __typename?: 'InstrumentTypeType' } & Pick<Types.InstrumentTypeType, 'uid' | 'name'>>;
...
export type AddLaboratoryInstrumentMutation = { __typename?: 'Mutation' } & {
...
export type EditLaboratoryInstrumentMutation = { __typename?: 'Mutation' } & {
...
export type AddInstrumentInterfaceMutation = { __typename?: 'Mutation' } & {
...
export type AddMethodMutation = { __typename?: 'Mutation' } & {
    createMethod:
...
export type EditMethodMutation = { __typename?: 'Mutation' } & {
    updateMethod:
        | ({ __typename?: 'MethodType' } & Pick<Types.MethodType, 'uid' | 'name' | 'description' | 'keyword'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditUnitMutation = { __typename?: 'Mutation' } & {
    updateUnit:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'UnitType' } & Pick<Types.UnitType, 'uid' | 'name' | 'description'>);
};
