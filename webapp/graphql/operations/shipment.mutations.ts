...
export type EditReferralLaboratoryMutation = { __typename?: 'Mutation' } & {
              ...
              shipments?: Types.Maybe<
                  Array<
                      { __typename?: 'ShipmentType' } & Pick<
                          Types.ShipmentType,
                          'uid' | 'shipmentId' | 'assignedCount' | 'state' | 'laboratoryUid' | 'createdAt'
...
export type UpdateShipmentMutation = { __typename?: 'Mutation' } & {
    updateShipment:
        ...
        | ({ __typename: 'ShipmentType' } & Pick<
              Types.ShipmentType,
              'uid' | 'shipmentId' | 'assignedCount' | 'state' | 'incoming' | 'comment' | 'createdAt' | 'courier'
          > & { laboratory?: Types.Maybe<{ __typename?: 'LaboratoryType' } & Pick<Types.LaboratoryType, 'uid' | 'name'>> });
};
...
export type ActionShipmentMutation = { __typename?: 'Mutation' } & {
    actionShipment:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ShipmentType' } & Pick<Types.ShipmentType, 'uid' | 'state'>);
};
