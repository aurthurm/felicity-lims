...
export function useGetAllReferralLaboratoriesQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllReferralLaboratoriesQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllReferralLaboratoriesQuery, GetAllReferralLaboratoriesQueryVariables | undefined>({ query: GetAllReferralLaboratoriesDocument, variables: undefined, ...options });
};
...
export function useGetAllShipmentsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllShipmentsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllShipmentsQuery, GetAllShipmentsQueryVariables | undefined>({ query: GetAllShipmentsDocument, variables: undefined, ...options });
};
...
export function useGetShipmentByUidQuery(options?: Omit<Urql.UseQueryArgs<never, GetShipmentByUidQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetShipmentByUidQuery, GetShipmentByUidQueryVariables | undefined>({ query: GetShipmentByUidDocument, variables: undefined, ...options });
};
...
export function useManifestReportQuery(options?: Omit<Urql.UseQueryArgs<never, ManifestReportQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<ManifestReportQuery, ManifestReportQueryVariables | undefined>({ query: ManifestReportDocument, variables: undefined, ...options });
};