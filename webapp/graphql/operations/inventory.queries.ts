...
export function useGetAllHazardsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllHazardsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllHazardsQuery, GetAllHazardsQueryVariables | undefined>({ query: GetAllHazardsDocument, variables: undefined, ...options });
};
...
export function useGetAllStockCategoriesQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockCategoriesQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockCategoriesQuery, GetAllStockCategoriesQueryVariables | undefined>({ query: GetAllStockCategoriesDocument, variables: undefined, ...options });
};
...
export function useGetAllStockUnitsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockUnitsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockUnitsQuery, GetAllStockUnitsQueryVariables | undefined>({ query: GetAllStockUnitsDocument, variables: undefined, ...options });
};
...
export function useGetAllStockItemsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockItemsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockItemsQuery, GetAllStockItemsQueryVariables | undefined>({ query: GetAllStockItemsDocument, variables: undefined, ...options });
};
...
export function useGetAllStockItemVariantsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockItemVariantsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockItemVariantsQuery, GetAllStockItemVariantsQueryVariables | undefined>({ query: GetAllStockItemVariantsDocument, variables: undefined, ...options });
};
...
export function useGetAllStockProductsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockProductsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockProductsQuery, GetAllStockProductsQueryVariables | undefined>({ query: GetAllStockProductsDocument, variables: undefined, ...options });
};
...
export function useGetAllStockLotsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockLotsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockLotsQuery, GetAllStockLotsQueryVariables | undefined>({ query: GetAllStockLotsDocument, variables: undefined, ...options });
};
...
export function useGetAllStockOrdersQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockOrdersQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockOrdersQuery, GetAllStockOrdersQueryVariables | undefined>({ query: GetAllStockOrdersDocument, variables: undefined, ...options });
};
...
export function useGetAllStockOrderProductsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllStockOrderProductsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllStockOrderProductsQuery, GetAllStockOrderProductsQueryVariables | undefined>({ query: GetAllStockOrderProductsDocument, variables: undefined, ...options });
};
