...
export function useGetAllStockItemVariantsQuery(
    options: Omit<Urql.UseQueryArgs<never, GetAllStockItemVariantsQueryVariables>, 'query'> = {}
) {
...
export function useGetAllStockOrderProductsQuery(
    options: Omit<Urql.UseQueryArgs<never, GetAllStockOrderProductsQueryVariables>, 'query'> = {}
) {
...
export function useGetAllStockAdjustmentsQuery(
    options: Omit<Urql.UseQueryArgs<never, GetAllStockAdjustmentsQueryVariables>, 'query'> = {}
) {
