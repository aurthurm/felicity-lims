...
export type GetReflexRuleByUidQuery = { __typename?: 'Query' } & {
    reflexRuleByUid?: Types.Maybe<
        { __typename?: 'ReflexRuleType' } & Pick<Types.ReflexRuleType, 'uid' | 'name' | 'description'> & {
                reflexActions?: Types.Maybe<
                    Array<
                        { __typename: 'ReflexActionType' } & Pick<Types.ReflexActionType, 'uid' | 'level' | 'description'> & {
                                analyses?: Types.Maybe<Array<{ __typename: 'AnalysisType' } & Pick<Types.AnalysisType, 'uid' | 'name'>>>;
                                brains?: Types.Maybe<
                                    Array<
                                        { __typename: 'ReflexBrainType' } & Pick<Types.ReflexBrainType, 'uid' | 'description'> & {
                                                conditions: Array<
                                                    { __typename?: 'ReflexBrainConditionType' } & Pick<
                                                        Types.ReflexBrainConditionType,
                                                        'description' | 'priority'
                                                    > & {
                                                            criteria?: Types.Maybe<
                                                                Array<
                                                                    { __typename: 'ReflexBrainConditionCriteriaType' } & Pick<
                                                                        Types.ReflexBrainConditionCriteriaType,
                                                                        'analysisUid' | 'operator' | 'value'
                                                                    > & {
                                                ...
                                                actions: Array<
                                                    { __typename: 'ReflexBrainActionType' } & {
                                                        addNew?: Types.Maybe<
                                                            Array<
                                                                { __typename: 'ReflexBrainAdditionType' } & Pick<
                                                                    Types.ReflexBrainAdditionType,
                                                                    'analysisUid' | 'count'
                                                                > & {
                                                                        analysis?: Types.Maybe<
                                                                            { __typename: 'AnalysisType' } & Pick<
                                                            ...
                                                            >
                                                        >;
                                                        finalise?: Types.Maybe<
                                                            Array<
                                                                { __typename: 'ReflexBrainFinalType' } & Pick<
                                                                    Types.ReflexBrainFinalType,
                                                                    'analysisUid' | 'value'
                                                                > & {
                                                                        analysis?: Types.Maybe<
                                                                            { __typename: 'AnalysisType' } & Pick<
