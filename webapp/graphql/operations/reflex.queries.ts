...
export type GetAllReflexRulesQuery = { __typename?: 'Query' } & {
    reflexRuleAll: { __typename?: 'ReflexRuleCursorPage' } & Pick<Types.ReflexRuleCursorPage, 'totalCount'> & {
            items?: Types.Maybe<
                Array<
                    { __typename?: 'ReflexRuleType' } & Pick<Types.ReflexRuleType, 'uid' | 'name' | 'description'> & {
...
export type GetAllReflexTriggersQuery = { __typename?: 'Query' } & {
    reflexTriggerAll: Array<
        ...
        > & {
                ...
                decisions?: Types.Maybe<
                    Array<{ __typename?: 'ReflexDecisionType' } & Pick<Types.ReflexDecisionType, 'uid' | 'description' | 'priority'>>
                >;
            }
    >;
};
...
export function useGetAllReflexRulesQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllReflexRulesQueryVariables | undefined>, 'query'>) {
    return Urql.useQuery<GetAllReflexRulesQuery, GetAllReflexRulesQueryVariables | undefined>({
        query: GetAllReflexRulesDocument,
        variables: undefined,
        ...options,
    });
}
...
export function useGetReflexRuleByUidQuery(
    options?: Omit<Urql.UseQueryArgs<never, GetReflexRuleByUidQueryVariables | undefined>, 'query'>,
) {
    return Urql.useQuery<GetReflexRuleByUidQuery, GetReflexRuleByUidQueryVariables | undefined>({
        query: GetReflexRuleByUidDocument,
        variables: undefined,
        ...options,
    });
}
...
export function useGetAllReflexTriggersQuery(
    options?: Omit<Urql.UseQueryArgs<never, GetAllReflexTriggersQueryVariables | undefined>, 'query'>,
) {
    return Urql.useQuery<GetAllReflexTriggersQuery, GetAllReflexTriggersQueryVariables | undefined>({
        query: GetAllReflexTriggersDocument,
        variables: undefined,
        ...options,
    });
}
