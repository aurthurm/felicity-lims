...
export function useGetDocumentFolderAllQuery(options?: Omit<Urql.UseQueryArgs<never, GetDocumentFolderAllQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetDocumentFolderAllQuery, GetDocumentFolderAllQueryVariables | undefined>({ query: GetDocumentFolderAllDocument, variables: undefined, ...options });
};
...
export function useGetDocumentAllQuery(options?: Omit<Urql.UseQueryArgs<never, GetDocumentAllQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetDocumentAllQuery, GetDocumentAllQueryVariables | undefined>({ query: GetDocumentAllDocument, variables: undefined, ...options });
};
...
export function useGetDocumentVersionByBidQuery(options?: Omit<Urql.UseQueryArgs<never, GetDocumentVersionByBidQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetDocumentVersionByBidQuery, GetDocumentVersionByBidQueryVariables | undefined>({ query: GetDocumentVersionByBidDocument, variables: undefined, ...options });
};