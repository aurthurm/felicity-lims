...
export function useGetSmsTemplatesByTargetQuery(options?: Omit<Urql.UseQueryArgs<never, GetSmsTemplatesByTargetQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetSmsTemplatesByTargetQuery, GetSmsTemplatesByTargetQueryVariables | undefined>({ query: GetSmsTemplatesByTargetDocument, variables: undefined, ...options });
};