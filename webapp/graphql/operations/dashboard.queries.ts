...
export function useGetSampleGroupByStatusQuery(
    options: Omit<Urql.UseQueryArgs<never, GetSampleGroupByStatusQueryVariables>, 'query'> = {}
) {
...
export function useGetExtrasGroupByStatusQuery(
    options: Omit<Urql.UseQueryArgs<never, GetExtrasGroupByStatusQueryVariables>, 'query'> = {}
) {
...
export function useGetAnalysisGroupByStatusQuery(
    options: Omit<Urql.UseQueryArgs<never, GetAnalysisGroupByStatusQueryVariables>, 'query'> = {}
) {
...
export function useGetWorksheetGroupByStatusQuery(
    options: Omit<Urql.UseQueryArgs<never, GetWorksheetGroupByStatusQueryVariables>, 'query'> = {}
) {
...
export function useGetAnalysisGroupByInstrumentQuery(
    options: Omit<Urql.UseQueryArgs<never, GetAnalysisGroupByInstrumentQueryVariables>, 'query'> = {}
) {
...
export function useSampleProcessPeformanceQuery(
    options: Omit<Urql.UseQueryArgs<never, SampleProcessPeformanceQueryVariables>, 'query'> = {}
) {
...
export function useGetAnalysisProcessPeformanceQuery(
    options: Omit<Urql.UseQueryArgs<never, GetAnalysisProcessPeformanceQueryVariables>, 'query'> = {}
) {
