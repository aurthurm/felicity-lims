...
export type AddReflexActionMutation = { __typename?: 'Mutation' } & {
    createReflexAction:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ReflexActionType' } & Pick<Types.ReflexActionType, 'uid' | 'description' | 'level'> & {
                  analyses?: Types.Maybe<Array<{ __typename?: 'AnalysisType' } & Pick<Types.AnalysisType, 'uid' | 'name'>>>;
                  reflexRule?: Types.Maybe<{ __typename?: 'ReflexRuleType' } & Pick<Types.ReflexRuleType, 'uid' | 'name'>>;
              });
};
...
export type AddReflexBrainMutation = { __typename?: 'Mutation' } & {
    createReflexBrain:
        ...
        | ({ __typename: 'ReflexBrainType' } & Pick<Types.ReflexBrainType, 'uid' | 'description'> & {
                  conditions: Array<
                      { __typename?: 'ReflexBrainConditionType' } & Pick<Types.ReflexBrainConditionType, 'description' | 'priority'> & {
                  ...
                  actions: Array<
                      { __typename: 'ReflexBrainActionType' } & {
                          ...
                          finalise?: Types.Maybe<
                              Array<
                                  { __typename: 'ReflexBrainFinalType' } & Pick<Types.ReflexBrainFinalType, 'analysisUid' | 'value'> & {
                                          analysis?: Types.Maybe<
                                              { __typename: 'AnalysisType' } & Pick<Types.AnalysisType, 'name'> & {
                                                      resultOptions?: Types.Maybe<
                                                          Array<
                                                              { __typename: 'ResultOptionType' } & Pick<
                                                                  Types.ResultOptionType,
...
export type DeleteReflexBrainMutation = { __typename?: 'Mutation' } & {
    deleteReflexBrain: { __typename: 'DeletedItem' } & Pick<Types.DeletedItem, 'uid'>;
};
