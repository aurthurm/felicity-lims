...
export type AddCountryMutation = { __typename?: 'Mutation' } & {
    createCountry:
        | ({ __typename: 'CountryType' } & Pick<Types.CountryType, 'uid' | 'name' | 'code'>)
...
export type EditCountryMutation = { __typename?: 'Mutation' } & {
    updateCountry:
        | ({ __typename: 'CountryType' } & Pick<Types.CountryType, 'uid' | 'name' | 'code'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type AddProvinceMutation = { __typename?: 'Mutation' } & {
    createProvince:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ProvinceType' } & Pick<Types.ProvinceType, 'uid' | 'name' | 'code' | 'countryUid'>);
};
...
export type EditProvinceMutation = { __typename?: 'Mutation' } & {
    updateProvince:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ProvinceType' } & Pick<Types.ProvinceType, 'uid' | 'name' | 'code' | 'countryUid'>);
};
...
export type AddDistrictMutation = { __typename?: 'Mutation' } & {
    createDistrict:
        | ({ __typename: 'DistrictType' } & Pick<Types.DistrictType, 'uid' | 'name' | 'code' | 'provinceUid'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditDistrictMutation = { __typename?: 'Mutation' } & {
    updateDistrict:
        | ({ __typename: 'DistrictType' } & Pick<Types.DistrictType, 'uid' | 'name' | 'code' | 'provinceUid'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
