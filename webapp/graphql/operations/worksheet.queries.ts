...
export type GetAllWorksheetTemplatesQuery = { __typename?: 'Query' } & {
    worksheetTemplateAll: Array<
        { __typename?: 'WorkSheetTemplateType' } & Pick<
            Types.WorkSheetTemplateType,
            | 'uid'
            | 'name'
            | 'reserved'
            | 'numberOfSamples'
...
export type GetAllWorksheetsQuery = { __typename?: 'Query' } & {
    worksheetAll: { __typename?: 'WorkSheetCursorPage' } & Pick<Types.WorkSheetCursorPage, 'totalCount'> & {
            pageInfo: { __typename?: 'PageInfo' } & Pick<Types.PageInfo, 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | 'endCursor'>;
            items?: Types.Maybe<
                Array<
                    { __typename?: 'WorkSheetType' } & Pick<
                        Types.WorkSheetType,
                        'uid' | 'worksheetId' | 'numberOfSamples' | 'assignedCount' | 'state' | 'createdAt'
                    > & {
                            analyst?: Types.Maybe<
                                { __typename?: 'UserType' } & Pick<Types.UserType, 'uid' | 'userName' | 'firstName' | 'lastName'>
                            >;
                            instrument?: Types.Maybe<{ __typename?: 'InstrumentType' } & Pick<Types.InstrumentType, 'uid' | 'name'>>;
                            analysis?: Types.Maybe<{ __typename?: 'AnalysisType' } & Pick<Types.AnalysisType, 'uid' | 'name'>>;
                        }
...
export type GetWorkSheetByUidQuery = { __typename?: 'Query' } & {
    worksheetByUid: { __typename?: 'WorkSheetType' } & Pick<
        Types.WorkSheetType,
        'uid' | 'worksheetId' | 'numberOfSamples' | 'assignedCount' | 'reserved' | 'state' | 'createdAt'
    > & {
            analyst?: Types.Maybe<{ __typename?: 'UserType' } & Pick<Types.UserType, 'uid' | 'userName' | 'firstName' | 'lastName'>>;
            sampleType?: Types.Maybe<{ __typename?: 'SampleTypeTyp' } & Pick<Types.SampleTypeTyp, 'name'>>;
            instrument?: Types.Maybe<{ __typename?: 'InstrumentType' } & Pick<Types.InstrumentType, 'uid' | 'name'>>;
            template?: Types.Maybe<{ __typename?: 'WorkSheetTemplateType' } & Pick<Types.WorkSheetTemplateType, 'uid' | 'name'>>;
            analysis?: Types.Maybe<{ __typename?: 'AnalysisType' } & Pick<Types.AnalysisType, 'uid' | 'name'>>;
            analysisResults?: Types.Maybe<
                Array<
                    { __typename?: 'AnalysisResultType' } & Pick<
                        Types.AnalysisResultType,
                        'uid' | 'result' | 'status' | 'worksheetPosition' | 'retest' | 'reportable'
                    > & {
                            ...
                            >;
                            sample: { __typename?: 'SampleType' } & Pick<Types.SampleType, 'uid' | 'sampleId' | 'priority'> & {
                                    analysisRequest?: Types.Maybe<
                                        { __typename?: 'AnalysisRequestType' } & Pick<Types.AnalysisRequestType, 'uid'> & {
                                                client?: Types.Maybe<
                                                    { __typename?: 'ClientType' } & Pick<Types.ClientType, 'uid' | 'name'>
                                                >;
                                                patient: { __typename?: 'PatientType' } & Pick<
                                                    Types.PatientType,
                                                    'uid' | 'firstName' | 'lastName' | 'clientPatientId' | 'patientId'
                                                >;
                                            }
                                    >;
...
export function useGetAllWorksheetTemplatesQuery(
    options?: Omit<Urql.UseQueryArgs<never, GetAllWorksheetTemplatesQueryVariables | undefined>, 'query'>,
) {
    return Urql.useQuery<GetAllWorksheetTemplatesQuery, GetAllWorksheetTemplatesQueryVariables | undefined>({
        query: GetAllWorksheetTemplatesDocument,
        variables: undefined,
        ...options,
    });
}
...
export function useGetAllWorksheetsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllWorksheetsQueryVariables | undefined>, 'query'>) {
    return Urql.useQuery<GetAllWorksheetsQuery, GetAllWorksheetsQueryVariables | undefined>({
        query: GetAllWorksheetsDocument,
        variables: undefined,
        ...options,
    });
}
...
export function useGetWorkSheetByUidQuery(options?: Omit<Urql.UseQueryArgs<never, GetWorkSheetByUidQueryVariables | undefined>, 'query'>) {
    return Urql.useQuery<GetWorkSheetByUidQuery, GetWorkSheetByUidQueryVariables | undefined>({
        query: GetWorkSheetByUidDocument,
        variables: undefined,
        ...options,
    });
}
