...
export function useGetAllWorksheetTemplatesQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllWorksheetTemplatesQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllWorksheetTemplatesQuery, GetAllWorksheetTemplatesQueryVariables | undefined>({ query: GetAllWorksheetTemplatesDocument, variables: undefined, ...options });
};
...
export function useGetAllWorksheetsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllWorksheetsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllWorksheetsQuery, GetAllWorksheetsQueryVariables | undefined>({ query: GetAllWorksheetsDocument, variables: undefined, ...options });
};
...
export function useGetWorkSheetByUidQuery(options?: Omit<Urql.UseQueryArgs<never, GetWorkSheetByUidQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetWorkSheetByUidQuery, GetWorkSheetByUidQueryVariables | undefined>({ query: GetWorkSheetByUidDocument, variables: undefined, ...options });
};