...
export type AddClientMutation = { __typename?: 'Mutation' } & {
    createClient:
        | ({ __typename: 'ClientType' } & Pick<Types.ClientType, 'uid' | 'name' | 'code' | 'districtUid'> & {
...
export type AddClientContactMutation = { __typename?: 'Mutation' } & {
    createClientContact:
...
export type EditClientContactMutation = { __typename?: 'Mutation' } & {
    updateClientContact:
        | ({ __typename: 'ClientContactType' } & Pick<
              Types.ClientContactType,
              'uid' | 'firstName' | 'lastName' | 'email' | 'mobilePhone' | 'consentSms'
