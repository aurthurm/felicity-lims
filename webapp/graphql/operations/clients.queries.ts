...
export function useGetAllClientsQuery(options?: Omit<Urql.UseQueryArgs<never, GetAllClientsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetAllClientsQuery, GetAllClientsQueryVariables | undefined>({ query: GetAllClientsDocument, variables: undefined, ...options });
};
...
export function useSearchClientsQuery(options?: Omit<Urql.UseQueryArgs<never, SearchClientsQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<SearchClientsQuery, SearchClientsQueryVariables | undefined>({ query: SearchClientsDocument, variables: undefined, ...options });
};
...
export function useGetClientContactsByClientUidQuery(options?: Omit<Urql.UseQueryArgs<never, GetClientContactsByClientUidQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetClientContactsByClientUidQuery, GetClientContactsByClientUidQueryVariables | undefined>({ query: GetClientContactsByClientUidDocument, variables: undefined, ...options });
};
...
export function useGetClientByUidQuery(options?: Omit<Urql.UseQueryArgs<never, GetClientByUidQueryVariables | undefined>, 'query'>) {
  return Urql.useQuery<GetClientByUidQuery, GetClientByUidQueryVariables | undefined>({ query: GetClientByUidDocument, variables: undefined, ...options });
};