...
export function useGetAllLaboratoryInstrumentsQuery(
    options: Omit<Urql.UseQueryArgs<never, GetAllLaboratoryInstrumentsQueryVariables>, 'query'> = {}
) {
...
export function useGetInstrumentInterfacesQuery(
    options: Omit<Urql.UseQueryArgs<never, GetInstrumentInterfacesQueryVariables>, 'query'> = {}
) {
