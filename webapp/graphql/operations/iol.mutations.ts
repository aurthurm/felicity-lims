...
export type ParseAnalyserMessageMutation = { __typename?: 'Mutation' } & {
    parseAnalyserMessage:
        | ({ __typename: 'AnalyzerParsedMessageType' } & Pick<Types.AnalyzerParsedMessageType, 'message' | 'seperators'>)
...
export type ExtractAnalyserMessageMutation = { __typename?: 'Mutation' } & {
    extractAnalyserMessage:
        | ({ __typename: 'AnalyzerExtractedMessageType' } & Pick<Types.AnalyzerExtractedMessageType, 'message'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
