...
export type AddCodingStandardMutation = { __typename?: 'Mutation' } & {
    createCodingStandard:
        | ({ __typename: 'CodingStandardType' } & Pick<Types.CodingStandardType, 'uid' | 'name' | 'description'>)
...
export type EditCodingStandardMutation = { __typename?: 'Mutation' } & {
...
export type AddSampleTypeMutation = { __typename?: 'Mutation' } & {
    createSampleType:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'SampleTypeTyp' } & Pick<Types.SampleTypeTyp, 'uid' | 'name' | 'abbr' | 'description' | 'active'>);
};
...
export type EditSampleTypeMutation = { __typename?: 'Mutation' } & {
    updateSampleType:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'SampleTypeTyp' } & Pick<Types.SampleTypeTyp, 'uid' | 'name' | 'abbr' | 'description' | 'active'>);
};
...
export type AddSampleTypeMappingMutation = { __typename?: 'Mutation' } & {
    createSampleTypeMapping:
        ...
        | ({ __typename?: 'SampleTypeMappingType' } & Pick<
              ...
              'uid' | 'name' | 'description' | 'code' | 'codingStandardUid' | 'sampleTypeUid'
...
export type ReInstateSamplesMutation = { __typename?: 'Mutation' } & {
    reInstateSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ResultedSampleListingType' } & {
              samples: Array<{ __typename?: 'SamplesWithResults' } & Pick<Types.SamplesWithResults, 'uid' | 'status'>>;
          });
};
...
export type CloneSamplesMutation = { __typename?: 'Mutation' } & {
    cloneSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename?: 'OperationSuccess' }
        | ({ __typename: 'SampleListingType' } & {
              samples: Array<
                  { __typename?: 'SampleType' } & Pick<Types.SampleType, 'uid' | 'parentId' | 'sampleId' | 'priority' | 'status'> & {
...
export type DeriveAnalysisRequestMutation = { __typename?: 'Mutation' } & {
    deriveAnalysisRequest:
        | ({ __typename: 'AnalysisRequestWithSamples' } & Pick<Types.AnalysisRequestWithSamples, 'uid'> & {
                  samples?: Types.Maybe<
                      Array<
                          { __typename?: 'SampleType' } & Pick<
                              Types.SampleType,
                              'uid' | 'parentId' | 'sampleId' | 'priority' | 'status'
                          > & {
                                  sampleType?: Types.Maybe<{ __typename?: 'SampleTypeTyp' } & Pick<Types.SampleTypeTyp, 'uid' | 'name'>>;
                                  analyses?: Types.Maybe<
                                      Array<{ __typename?: 'AnalysisType' } & Pick<Types.AnalysisType, 'uid' | 'name' | 'sortKey'>>
...
export type CancelSamplesMutation = { __typename?: 'Mutation' } & {
    cancelSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ResultedSampleListingType' } & {
              samples: Array<{ __typename?: 'SamplesWithResults' } & Pick<Types.SamplesWithResults, 'uid' | 'status'>>;
...
export type ReceiveSamplesMutation = { __typename?: 'Mutation' } & {
    receiveSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ResultedSampleListingType' } & {
              samples: Array<{ __typename?: 'SamplesWithResults' } & Pick<Types.SamplesWithResults, 'uid' | 'status'>>;
...
export type PublishSamplesMutation = { __typename?: 'Mutation' } & {
    publishSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename?: 'OperationSuccess' }
        | ({ __typename: 'SampleListingType' } & Pick<Types.SampleListingType, 'message'> & {
                  samples: Array<
                      { __typename?: 'SampleType' } & Pick<Types.SampleType, 'uid' | 'status' | 'publishedByUid' | 'datePublished'>
                  >;
              });
};
...
export type PrintSamplesMutation = { __typename?: 'Mutation' } & {
    printSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename?: 'OperationSuccess' }
        | ({ __typename: 'SampleListingType' } & {
              samples: Array<{ __typename?: 'SampleType' } & Pick<Types.SampleType, 'uid' | 'status'>>;
          });
};
...
export type InvalidateSamplesMutation = { __typename?: 'Mutation' } & {
    invalidateSamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename?: 'OperationSuccess' }
        | ({ __typename: 'SampleListingType' } & {
...
export type VerifySamplesMutation = { __typename?: 'Mutation' } & {
    verifySamples:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | { __typename?: 'OperationSuccess' }
        | ({ __typename: 'SampleListingType' } & {
...
export type RejectSamplesMutation = { __typename?: 'Mutation' } & {
    rejectSamples:
        ...
        | ({ __typename: 'SampleListingType' } & {
              samples: Array<
                  { __typename?: 'SampleType' } & Pick<Types.SampleType, 'uid' | 'status'> & {
...
export type AddResultOptionMutation = { __typename?: 'Mutation' } & {
    createResultOption:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
...
export type EditResultOptionMutation = { __typename?: 'Mutation' } & {
    updateResultOption:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'ResultOptionType' } & Pick<Types.ResultOptionType, 'uid' | 'optionKey' | 'value' | 'analysisUid'> & {
                  sampleTypes?: Types.Maybe<Array<{ __typename?: 'SampleTypeTyp' } & Pick<Types.SampleTypeTyp, 'uid' | 'name'>>>;
...
export type AddAnalysisInterimMutation = { __typename?: 'Mutation' } & {
...
export type EditAnalysisInterimMutation = { __typename?: 'Mutation' } & {
...
export type AddAnalysisCorrectionFactorMutation = { __typename?: 'Mutation' } & {
...
export type EditAnalysisCorrectionFactorMutation = { __typename?: 'Mutation' } & {
...
export type AddAnalysisUncertaintyMutation = { __typename?: 'Mutation' } & {
    createAnalysisUncertainty:
        | ({ __typename?: 'AnalysisUncertaintyType' } & Pick<
              Types.AnalysisUncertaintyType,
              'uid' | 'value' | 'min' | 'max' | 'analysisUid' | 'instrumentUid' | 'methodUid'
          >)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditAnalysisUncertaintyMutation = { __typename?: 'Mutation' } & {
...
export type AddAnalysisDetectionLimitMutation = { __typename?: 'Mutation' } & {
...
export type EditAnalysisDetectionLimitMutation = { __typename?: 'Mutation' } & {
        ...
        | ({ __typename: 'AnalysisWithProfiles' } & Pick<
          ...
          > & {
                  ...
                  resultOptions?: Types.Maybe<
                      Array<{ __typename?: 'ResultOptionType' } & Pick<Types.ResultOptionType, 'uid' | 'optionKey' | 'value'>>
                  >;
...
export type AddAnalysisMappingMutation = { __typename?: 'Mutation' } & {
    createAnalysisMapping:
        | ({ __typename?: 'AnalysisMappingType' } & Pick<
              Types.AnalysisMappingType,
              'uid' | 'name' | 'description' | 'code' | 'codingStandardUid' | 'analysisUid'
          > & { codingStandard?: Types.Maybe<{ __typename?: 'CodingStandardType' } & Pick<Types.CodingStandardType, 'name'>> })
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
    ...
    createProfile:
        ...
        | ({ __typename?: 'ProfileType' } & Pick<
          ...
          > & {
                  sampleTypes?: Types.Maybe<Array<{ __typename?: 'SampleTypeTyp' } & Pick<Types.SampleTypeTyp, 'uid' | 'name'>>>;
                  analyses?: Types.Maybe<
                      Array<{ __typename?: 'AnalysisType' } & Pick<Types.AnalysisType, 'uid' | 'name' | 'keyword' | 'active'>>
                  >;
              });
};
...
export type AddProfileMappingMutation = { __typename?: 'Mutation' } & {
    createProfileMapping:
        ...
        | ({ __typename?: 'ProfileMappingType' } & Pick<
              ...
              'uid' | 'name' | 'description' | 'code' | 'codingStandardUid' | 'profileUid'
          > & { codingStandard?: Types.Maybe<{ __typename?: 'CodingStandardType' } & Pick<Types.CodingStandardType, 'name'>> });
};
...
export type EditAnalysisTemplateMutation = { __typename?: 'Mutation' } & {
...
export type EditSampleApplyTemplateMutation = { __typename?: 'Mutation' } & {
    samplesApplyTemplate:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ResultedSampleListingType' } & {
              samples: Array<{ __typename?: 'SamplesWithResults' } & Pick<Types.SamplesWithResults, 'uid'>>;
          });
};
...
export type SampleManageAnalysisMutation = { __typename?: 'Mutation' } & {
    manageAnalyses:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'ResultedSampleListingType' } & {
              samples: Array<{ __typename?: 'SamplesWithResults' } & Pick<Types.SamplesWithResults, 'uid'>>;
...
export type AddAnalysisCategoryMutation = { __typename?: 'Mutation' } & {
    createAnalysisCategory:
        | ({ __typename?: 'AnalysisCategoryType' } & Pick<Types.AnalysisCategoryType, 'uid' | 'name' | 'active' | 'description'> & {
...
export type AddAnalysisRequestMutation = { __typename?: 'Mutation' } & {
    createAnalysisRequest:
        | ({ __typename: 'AnalysisRequestWithSamples' } & Pick<
              Types.AnalysisRequestWithSamples,
              'uid' | 'clientRequestId' | 'createdAt'
          > & {
...
export type SubmitAnalysisResultsMutation = { __typename?: 'Mutation' } & {
    submitAnalysisResults:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'ResultOperationType' } & Pick<Types.ResultOperationType, 'message' | 'isBackground'> & {
                  results?: Types.Maybe<
                      Array<
...
export type CancelAnalysisResultsMutation = { __typename?: 'Mutation' } & {
    cancelAnalysisResults:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'ResultListingType' } & {
              results: Array<{ __typename?: 'AnalysisResultType' } & Pick<Types.AnalysisResultType, 'uid' | 'status'>>;
          });
};
...
export type ReInstateAnalysisResultsMutation = { __typename?: 'Mutation' } & {
                  ...
                  results?: Types.Maybe<
                      Array<
                          { __typename?: 'AnalysisResultType' } & Pick<
                              ...
                              | 'dateSubmitted'
                              | 'dateVerified'
                          > & { verifiedBy?: Types.Maybe<Array<{ __typename?: 'UserType' } & Pick<Types.UserType, 'uid'>>> }
                      >
                  >;
              });
};
...
export type RetractAnalysisResultsMutation = { __typename?: 'Mutation' } & {
...
export type AddQcLevelMutation = { __typename?: 'Mutation' } & {
    createQcLevel:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
...
export type EditQcLevelMutation = { __typename?: 'Mutation' } & {
    updateQcLevel:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename?: 'QCLevelType' } & Pick<Types.QcLevelType, 'uid' | 'level'>);
};
                          ...
                          samples?: Types.Maybe<
                              Array<
                                  ...
                                  > & {
                                          ...
                                          analyses?: Types.Maybe<
                                              Array<
                                                  { __typename?: 'AnalysisType' } & Pick<Types.AnalysisType, 'uid' | 'name' | 'unitUid'> & {
                                                          unit?: Types.Maybe<
...
export type AddRejectionReasonMutation = { __typename?: 'Mutation' } & {
    createRejectionReason:
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>)
        | ({ __typename: 'RejectionReasonType' } & Pick<Types.RejectionReasonType, 'uid' | 'reason'>);
};
...
export type EditRejectionReasonMutation = { __typename?: 'Mutation' } & {
...
export function useAddAnalysisCorrectionFactorMutation() {
    return Urql.useMutation<AddAnalysisCorrectionFactorMutation, AddAnalysisCorrectionFactorMutationVariables>(
        AddAnalysisCorrectionFactorDocument,
    );
}
...
export function useEditAnalysisCorrectionFactorMutation() {
    return Urql.useMutation<EditAnalysisCorrectionFactorMutation, EditAnalysisCorrectionFactorMutationVariables>(
        EditAnalysisCorrectionFactorDocument,
    );
}
...
export function useAddAnalysisDetectionLimitMutation() {
    return Urql.useMutation<AddAnalysisDetectionLimitMutation, AddAnalysisDetectionLimitMutationVariables>(
        AddAnalysisDetectionLimitDocument,
    );
}
...
export function useEditAnalysisDetectionLimitMutation() {
    return Urql.useMutation<EditAnalysisDetectionLimitMutation, EditAnalysisDetectionLimitMutationVariables>(
        EditAnalysisDetectionLimitDocument,
    );
}
...
export function useEditAnalysisSpecificationMutation() {
    return Urql.useMutation<EditAnalysisSpecificationMutation, EditAnalysisSpecificationMutationVariables>(
        EditAnalysisSpecificationDocument,
    );
}
