...
export type AddGrindErrandMutation = { __typename?: 'Mutation' } & {
    createGrindErrand:
        | ({ __typename?: 'GrindErrandType' } & Pick<
              Types.GrindErrandType,
              'uid' | 'title' | 'description' | 'posterUid' | 'createdByUid' | 'createdAt'
          >)
...
export type EditGrindErrandMutation = { __typename?: 'Mutation' } & {
    updateGrindErrand:
        | ({ __typename?: 'GrindErrandType' } & Pick<
              Types.GrindErrandType,
              'uid' | 'title' | 'description' | 'category' | 'priority' | 'startDate' | 'endDate'
          > & {
                  poster?: Types.Maybe<{ __typename?: 'GrindPosterType' } & Pick<Types.GrindPosterType, 'uid'>>;
                  stamps: Array<{ __typename?: 'GrindStampType' } & Pick<Types.GrindStampType, 'uid'>>;
                  label?: Types.Maybe<{ __typename?: 'GrindLabelType' } & Pick<Types.GrindLabelType, 'uid'>>;
...
export type EditGrindErrandDiscussionMutation = { __typename?: 'Mutation' } & {
...
export type DeleteMilestoneMutation = { __typename?: 'Mutation' } & {
    deleteGrindMilestone: ({ __typename?: 'DeletedItem' } & Pick<Types.DeletedItem, 'uid'>) | { __typename?: 'OperationError' };
};
...
export type EditGrindSchemeMutation = { __typename?: 'Mutation' } & {
    updateGrindScheme:
        | ({ __typename?: 'GrindSchemeType' } & Pick<
              Types.GrindSchemeType,
              'uid' | 'title' | 'description' | 'startDate' | 'endDate' | 'createdAt'
...
export type AddGrindBoardMutation = { __typename?: 'Mutation' } & {
    createGrindBoard:
        | ({ __typename?: 'GrindBoardType' } & Pick<Types.GrindBoardType, 'uid' | 'title' | 'description' | 'createdAt'> & {
                  scheme?: Types.Maybe<{ __typename?: 'GrindSchemeType' } & Pick<Types.GrindSchemeType, 'uid' | 'title'>>;
                  createdBy?: Types.Maybe<{ __typename?: 'UserType' } & Pick<Types.UserType, 'uid' | 'firstName' | 'lastName'>>;
              })
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type EditGrindBoardMutation = { __typename?: 'Mutation' } & {
    updateGrindBoard:
        | ({ __typename?: 'GrindBoardType' } & Pick<Types.GrindBoardType, 'uid' | 'title' | 'description'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type AddGrindPosterMutation = { __typename?: 'Mutation' } & {
    createGrindPoster:
        | ({ __typename?: 'GrindPosterType' } & Pick<Types.GrindPosterType, 'uid' | 'title'> & {
                  errands: Array<{ __typename?: 'GrindErrandType' } & Pick<Types.GrindErrandType, 'uid'>>;
              })
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type AddGrindLabelMutation = { __typename?: 'Mutation' } & {
    createGrindLabel:
        | ({ __typename?: 'GrindLabelType' } & Pick<Types.GrindLabelType, 'uid' | 'title' | 'category'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type AddGrindStampMutation = { __typename?: 'Mutation' } & {
    createGrindStamp:
        | ({ __typename?: 'GrindStampType' } & Pick<Types.GrindStampType, 'uid' | 'title' | 'category'>)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type AddGrindMediaMutation = { __typename?: 'Mutation' } & {
    createGrindMedia:
        | ({ __typename?: 'GrindMediaType' } & Pick<
              ...
              'uid' | 'target' | 'targetUid' | 'filename' | 'originalName' | 'path' | 'size' | 'mimetype'
          >)
        | ({ __typename: 'OperationError' } & Pick<Types.OperationError, 'error' | 'suggestion'>);
};
...
export type DeleteGrindMediaMutation = { __typename?: 'Mutation' } & {
    deleteGrindMedia: ({ __typename?: 'DeletedItem' } & Pick<Types.DeletedItem, 'uid'>) | { __typename?: 'OperationError' };
};
...
export function useEditGrindErrandDiscussionMutation() {
    return Urql.useMutation<EditGrindErrandDiscussionMutation, EditGrindErrandDiscussionMutationVariables>(
