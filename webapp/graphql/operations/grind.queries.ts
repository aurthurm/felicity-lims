...
export function useGetGrindErrandDiscussionsQuery(
    options: Omit<Urql.UseQueryArgs<never, GetGrindErrandDiscussionsQueryVariables>, 'query'> = {}
) {
...
export function useGetGrindErrandDiscussionsByParentQuery(
    options: Omit<Urql.UseQueryArgs<never, GetGrindErrandDiscussionsByParentQueryVariables>, 'query'> = {}
) {
...
export function useGetGrindOccurrenciesByTargetQuery(
    options: Omit<Urql.UseQueryArgs<never, GetGrindOccurrenciesByTargetQueryVariables>, 'query'> = {}
) {
...
export function useGetGrindMilestonesByErrandQuery(
    options: Omit<Urql.UseQueryArgs<never, GetGrindMilestonesByErrandQueryVariables>, 'query'> = {}
) {
...
export function useGetGrindPostersByBoardQuery(
    options: Omit<Urql.UseQueryArgs<never, GetGrindPostersByBoardQueryVariables>, 'query'> = {}
) {
...
export function useGetGrindStampByCategoryQuery(
    options: Omit<Urql.UseQueryArgs<never, GetGrindStampByCategoryQueryVariables>, 'query'> = {}
) {
...
export function useDownloadGrindMediaFileUrlQuery(
    options: Omit<Urql.UseQueryArgs<never, DownloadGrindMediaFileUrlQueryVariables>, 'query'> = {}
) {
...
export function useDownloadGrindMediaFileQuery(
    options: Omit<Urql.UseQueryArgs<never, DownloadGrindMediaFileQueryVariables>, 'query'> = {}
) {
