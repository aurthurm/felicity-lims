 ...
 */
export const resetForm = (form: Record<string, any>): void => Object.keys(form).forEach(k => delete form[k]);
 ...
 */
export const mutateForm = (form: Record<string, any>, payload: Record<string, any>, reset = true): void => {
