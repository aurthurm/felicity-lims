...
export type Mutation = {
    ...
    updateUserPreferences: UserPreferenceResponse;
...
export type Query = {
    ...
    abxAstResultsByAnalysisResult?: Maybe<Array<AbxAstResultType>>;
...
export type QueryAbxAstResultsByAnalysisResultArgs = {
    analysisResultUid: Scalars['String']['input'];
};
...
export type QueryBillingOverviewMetricsArgs = {
    endDate?: InputMaybe<Scalars['DateTime']['input']>;
    startDate?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export type UserPreferenceResponse = OperationError | UserPreferenceType;
...
export type WorkSheetTypeSampleTypeAnalysisResultTypeReportMetaTypeUnknownObjectType =
    | AnalysisResultType
    | ReportMetaType
    | SampleType
    | UnknownObjectType
