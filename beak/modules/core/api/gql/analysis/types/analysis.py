...
from beak.modules.core.api.gql.client.types import ClientType, ClientContactType
from beak.modules.core.api.gql.instrument.types import InstrumentType, MethodType
from beak.modules.clinical.api.gql.patient.types import PatientType
from beak.modules.core.api.gql.setup.types import (
    UnitType,
    DistrictType,
    ProvinceType,
    LaboratoryType,
)
from beak.modules.core.api.gql.setup.types.department import DepartmentType
from beak.modules.core.api.gql.storage.types import StorageContainerType
from beak.modules.shared.api.gql.types.generic import PageInfo, JSONScalar, StrawberryMapper
