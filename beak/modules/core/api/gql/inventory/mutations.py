...
from beak.modules.core.api.gql.inventory import types
...
class InventoryMutations:
    ...
    async def update_stock_item(
        ...
        setattr(stock_item, "updated_by_uid", beak_user.uid)
    ...
    async def update_stock_item_variant(
        ...
        setattr(stock_item_variant, "updated_by_uid", beak_user.uid)
    ...
    async def update_stock_category(
        ...
        setattr(stock_category, "updated_by_uid", beak_user.uid)
    ...
    async def update_hazard(
        ...
        setattr(hazard, "updated_by_uid", beak_user.uid)
    ...
    async def update_stock_unit(
        ...
        setattr(stock_unit, "updated_by_uid", beak_user.uid)
    ...
    async def create_stock_receipt(
        ...
        adjustment = schemas.StockAdjustmentCreate(
            **{
                ...
                "remarks": "",
                "adjustment_by_uid": beak_user.uid,
            }
        )
