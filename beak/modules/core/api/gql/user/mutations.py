...
from beak.modules.shared.api.gql.types import MessageResponse, MessagesType, OperationError
from beak.modules.shared.api.gql.types.generic import StrawberryMapper
from beak.modules.core.api.gql.user import UserPreferenceType
from beak.modules.core.api.gql.user.types import (
    GroupType,
    PermissionType,
    UpdatedGroupPerms,
...
from beak.core.security import (
...
class UserMutations:
    ...
    async def update_user(
        ...
        user_in.updated_by_uid = beak_user.uid
    ...
    async def update_user_preferences(
        ...
        invalidate_user_preferences_cache(beak_user.uid)
