...
from beak.modules.core.api.gql.setup.types import ManufacturerType, SupplierType, LaboratoryType
from beak.modules.shared.api.gql.types import BytesScalar, PageInfo, JSONScalar
