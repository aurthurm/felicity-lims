...
from beak.modules.core.api.gql.document import types, inputs, responses
...
class DocumentMutations:
    ...
    async def update_document_version(
        ...
        update_data = {"thumbnail": thumbnail, "updated_by_uid": beak_user.uid}
    ...
    async def create_document_review_cycle(
        ...
        incoming: dict = {
            ...
            "updated_by_uid": beak_user.uid,
            "document_uid": payload.document,
            "initiated_by_uid": beak_user.uid,
