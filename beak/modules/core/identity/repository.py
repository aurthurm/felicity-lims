...
from beak.modules.core.identity.entities import Group, Permission, User, UserPreference
from beak.modules.core.identity.entities import laboratory_user
from beak.modules.core.identity.entities import permission_groups
...
class UserRepository(BaseRepository[User]):
    ...
    async def get_users_by_laboratory(self, laboratory_uid: str) -> list[User]:
        ...
        user_uids = await self.table_query(
            table=laboratory_user, columns=["user_uid"], laboratory_uid=laboratory_uid
        )
    ...
    async def get_laboratories_by_user(self, user_uid: str) -> list[str]:
        ...
        return await self.table_query(
            table=laboratory_user, columns=["laboratory_uid"], user_uid=user_uid
        )
