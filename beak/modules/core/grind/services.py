...
from beak.modules.core.grind.entities import (
    GrindScheme,
    GrindBoard,
    GrindPoster,
    GrindErrand,
...
from beak.modules.core.grind.repositories import (
    GrindSchemeRepository,
    GrindBoardRepository,
    GrindPosterRepository,
    GrindErrandRepository,
    GrindLabelRepository,
    GrindMediaRepository,
    GrindMilestoneRepository,
    GrindOccurrenceRepository,
    GrindStampRepository,
    GrindErrandDiscussionRepository,
)
from beak.modules.core.grind.schema import (
    GrindSchemeCreate,
    GrindSchemeUpdate,
    GrindBoardCreate,
    GrindBoardUpdate,
    ...
    GrindMediaCreate,
    GrindMediaUpdate,
    GrindMilestoneCreate,
    GrindMilestoneUpdate,
    GrindOccurrenceCreate,
    GrindOccurrenceUpdate,
    GrindStampCreate,
    GrindStampUpdate,
    GrindErrandDiscussionCreate,
    GrindErrandDiscussionUpdate,
)


class GrindSchemeService(
    BaseService[GrindScheme, GrindSchemeCreate, GrindSchemeUpdate]
):
    def __init__(self):
    ...
    async def add_members(self, uid: str, members: list[str]):
        await self.repository.table_insert(
            grind_scheme_member,
            mappings=[
                {"grind_scheme_uid": uid, "grind_user_uid": member}
...
class GrindPosterService(
    BaseService[GrindPoster, GrindPosterCreate, GrindPosterUpdate]
):
    def __init__(self):
    ...
    async def add_members(self, uid: str, members: list[str]):
        await self.repository.table_insert(
            grind_poster_member,
            mappings=[
                {"grind_poster_uid": uid, "grind_user_uid": member}
                for member in members
            ],
        )
    ...
    async def add_stamps(self, uid: str, stamps: list[str]):
        await self.repository.table_insert(
            grind_poster_stamp,
            mappings=[
                {"grind_poster_uid": uid, "grind_stamp_uid": stamp} for stamp in stamps
            ],
        )
...
class GrindErrandService(
    BaseService[GrindErrand, GrindErrandCreate, GrindErrandUpdate]
):
    def __init__(self):
    ...
    async def add_members(self, uid: str, members: list[str]):
        await self.repository.table_insert(
            grind_errand_member,
            mappings=[
                {"grind_errand_uid": uid, "grind_user_uid": member}
                for member in members
            ],
        )
    ...
    async def add_stamps(self, uid: str, stamps: list[str]):
        await self.repository.table_insert(
            grind_errand_stamp,
            mappings=[
                {"grind_errand_uid": uid, "grind_stamp_uid": stamp} for stamp in stamps
            ],
        )
...
class GrindErrandDiscussionService(
    BaseService[
        GrindErrandDiscussion, GrindErrandDiscussionCreate, GrindErrandDiscussionUpdate
    ]
):
    def __init__(self):
...
class GrindMilestoneService(
    BaseService[GrindMilestone, GrindMilestoneCreate, GrindMilestoneUpdate]
):
    def __init__(self):
        super().__init__(GrindMilestoneRepository())


class GrindOccurrenceService(
    BaseService[GrindOccurrence, GrindOccurrenceCreate, GrindOccurrenceUpdate]
):
    def __init__(self):
