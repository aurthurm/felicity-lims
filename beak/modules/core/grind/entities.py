...
from beak.modules.core.abstract import LabScopedEntity, BaseEntity
...
class GrindScheme(LabScopedEntity):
    ...
    members = relationship(
        "User",
        secondary=grind_scheme_member,
        backref="scheme_memberships",
        lazy="selectin",
    )
...
class GrindBoard(LabScopedEntity):
    ...
    scheme_uid = Column(
        String, ForeignKey("grind_scheme.uid"), nullable=True, unique=False
    )
...
class GrindPoster(LabScopedEntity):
    ...
    stamps = relationship(
        "GrindStamp", secondary=grind_poster_stamp, backref="posters", lazy="selectin"
    )
    ...
    members = relationship(
        "User",
        secondary=grind_poster_member,
        backref="poster_memberships",
        lazy="selectin",
    )
...
class GrindErrand(LabScopedEntity):
    ...
    # Many-to-many relationship with Stamp
    stamps = relationship(
        "GrindStamp", secondary=grind_errand_stamp, backref="errands", lazy="selectin"
    )
    ...
    members = relationship(
        "User",
        secondary=grind_errand_member,
        backref="errand_memberships",
        lazy="selectin",
    )
...
class GrindErrandDiscussion(LabScopedEntity):
    ...
    parent_uid = Column(
        String, ForeignKey("grind_errand_discussion.uid"), nullable=True
    )
    parent = relationship(
