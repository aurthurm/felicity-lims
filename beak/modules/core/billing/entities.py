...
from beak.modules.core.abstract import LabScopedEntity, MaybeLabScopedEntity, BaseEntity
from beak.modules.core.billing.enum import DiscountType, DiscountValueType, TransactionKind
...
class AnalysisDiscount(MaybeLabScopedEntity):
    ...
    value_type = Column(String, nullable=False, default=DiscountValueType.PERCENTAGE)
