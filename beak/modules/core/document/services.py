...
from beak.modules.core.document.entities import (
    DocumentCategory,
    DocumentTag,
    Document,
    DocumentStatus,
...
from beak.modules.core.document.repositories import (
    ...
    DocumentReviewCycleRepository,
    DocumentReviewStepRepository,
    DocumentTemplateRepository,
    DocumentSubscriptionRepository,
    DocumentAuditRepository,
)
from beak.modules.core.document.schemas import (
    ...
    DocumentReviewCycleCreate,
    DocumentReviewCycleUpdate,
    DocumentReviewStepCreate,
    DocumentReviewStepUpdate,
...
class DocumentCategoryService(
    BaseService[DocumentCategory, DocumentCategoryCreate, DocumentCategoryUpdate]
):
    def __init__(self):
...
class DocumentTagService(
    BaseService[DocumentTag, DocumentTagCreate, DocumentTagUpdate]
):
    def __init__(self):
...
class DocumentService(BaseService[Document, DocumentCreate, DocumentUpdate]):
    ...
    async def add_tag(self, uid: str, tag_uid: str) -> None:
        await self.repository.table_insert(
            document_tagged, [{"document_uid": uid, "document_tag_uid": tag_uid}]
        )
    ...
    async def add_author(self, uid: str, author_uid: str) -> None:
        await self.repository.table_insert(
            document_author, [{"document_uid": uid, "user_uid": author_uid}]
        )
    ...
    async def add_reader(self, uid: str, reader_uid: str) -> None:
        await self.repository.table_insert(
            document_reader, [{"document_uid": uid, "user_uid": reader_uid}]
        )
    ...
    async def remove_relation(
        self, source_uid: str, target_uid: str, relation_type: str
    ):
...
class DocumentStatusService(
    BaseService[DocumentStatus, DocumentStatusCreate, DocumentStatusUpdate]
):
    def __init__(self):
...
class DocumentFolderService(
    BaseService[DocumentFolder, DocumentFolderCreate, DocumentFolderUpdate]
):
    def __init__(self):
...
class DocumentVersionService(
    BaseService[DocumentVersion, DocumentVersionCreate, DocumentVersionUpdate]
):
    def __init__(self):
...
class DocumentReviewCycleService(
    BaseService[
        DocumentReviewCycle, DocumentReviewCycleCreate, DocumentReviewCycleUpdate
    ]
):
    def __init__(self):
...
class DocumentReviewStepService(
    BaseService[DocumentReviewStep, DocumentReviewStepCreate, DocumentReviewStepUpdate]
):
    def __init__(self):
...
class DocumentTemplateService(
    BaseService[DocumentTemplate, DocumentTemplateCreate, DocumentTemplateUpdate]
):
    def __init__(self):
...
class DocumentSubscriptionService(
    BaseService[
        DocumentSubscription, DocumentSubscriptionCreate, DocumentSubscriptionUpdate
    ]
):
    def __init__(self):
...
class DocumentAuditService(
    BaseService[DocumentAudit, DocumentAuditCreate, DocumentAuditUpdate]
):
    def __init__(self):
