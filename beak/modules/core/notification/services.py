...
from beak.modules.core.notification.entities import (
    ActivityFeed,
    ActivityStream,
    Notification,
    user_notification,
...
from beak.modules.core.notification.enum import NotificationChannel, NotificationObject
from beak.modules.core.notification.repository import (
    ActivityFeedRepository,
    ActivityStreamRepository,
    NotificationRepository,
)
from beak.modules.core.notification.schemas import (
    ActivityFeedCreate,
    ActivityFeedUpdate,
...
from beak.modules.core.setup.entities.setup import Department
from beak.modules.core.identity.entities import Group, User
...
class ActivityStreamService(
    ...
    async def stream(
        ...
        await broadcast.publish(
            NotificationChannel.ACTIVITIES, json.dumps(marshaller(stream))
        )
