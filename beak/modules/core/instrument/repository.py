...
from beak.modules.core.instrument.entities import (
...
class InstrumentInterfaceRepository(BaseRepository[InstrumentInterface]):
    def __init__(self) -> None:
        super().__init__(InstrumentInterface)
...
class InstrumentResultTranslationRepository(
    BaseRepository[InstrumentResultTranslation]
):
    def __init__(self) -> None:
