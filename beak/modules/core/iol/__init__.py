...
# BeakMeta is a service to contain all beak common metadata and Terminologies metadata mappings e.g to LOINC
# BeakLIMS sycs data from BeakMeta and does not allow instance level metadata setup if meta is activated


# BeakMeta will be implemented in NESTJS, NEXTJS, mongodb
# CodeSystem:
#     name
#
# CodeSystemInterOp:
