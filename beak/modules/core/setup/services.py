...
from beak.modules.core.setup.entities import Organization, OrganizationSetting
from beak.modules.core.setup.entities.location import Country, District, Province
from beak.modules.core.setup.entities.setup import (
    Department,
    Laboratory,
    LaboratorySetting,
    Manufacturer,
...
from beak.modules.core.setup.repositories import (
    CountryRepository,
...
from beak.modules.core.setup.repositories.setup import (
    OrganizationRepository,
    OrganizationSettingRepository,
)
from beak.modules.core.setup.schemas import (
    CountryCreate,
    CountryUpdate,
    DepartmentCreate,
    DepartmentUpdate,
...
class OrganizationService(
    ...
    async def get_by_setup_name(self, keyword="beak") -> Organization:
