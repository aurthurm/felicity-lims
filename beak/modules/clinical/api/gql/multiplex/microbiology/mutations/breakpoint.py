...
async def update_abx_test_method(
    ...
    setattr(abx_test_method, "updated_by_uid", beak_user.uid)
...
async def update_abx_breakpoint_type(
    ...
    setattr(abx_breakpoint_type, "updated_by_uid", beak_user.uid)
...
async def update_abx_host(info, uid: str, payload: AbxHostInputType) -> AbxHostResponse:
    ...
    setattr(abx_host, "updated_by_uid", beak_user.uid)
...
async def update_abx_site_of_infection(
    ...
    setattr(abx_site, "updated_by_uid", beak_user.uid)
...
async def update_abx_breakpoint(
    ...
    setattr(abx_breakpoint, "updated_by_uid", beak_user.uid)
