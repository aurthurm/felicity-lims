...
from beak.modules.clinical.api.gql.multiplex.microbiology import AbxMediumType, AbxQCRangeType
...
async def update_abx_medium(
    ...
    setattr(abx_medium, "updated_by_uid", beak_user.uid)
...
async def update_abx_qc_range(
    ...
    setattr(qc_range, "updated_by_uid", beak_user.uid)
