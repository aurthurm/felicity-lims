...
from beak.modules.clinical.api.gql.multiplex.microbiology import AbxASTPanelType
from beak.modules.clinical.api.gql.multiplex.microbiology.types import AbxASTResultType
...
async def update_abx_ast_panel(
    ...
    setattr(astp_panel, "updated_by_uid", beak_user.uid)
...
async def update_abx_ast_results(
    ...
    for result_payload in payload.results:
        ...
        setattr(ast_result, "updated_by_uid", beak_user.uid)
