...
from beak.apps.setup.entities import Organization, OrganizationSetting
from beak.apps.setup.entities.location import Country, District, Province
from beak.apps.setup.entities.setup import (
    Department,
    Laboratory,
    LaboratorySetting,
    Manufacturer,
...
from beak.apps.setup.repositories import (
    CountryRepository,
...
from beak.apps.setup.repositories.setup import (
    OrganizationRepository,
    OrganizationSettingRepository,
)
from beak.apps.setup.schemas import (
    CountryCreate,
    CountryUpdate,
    DepartmentCreate,
    DepartmentUpdate,
