...
from beak.apps.common.utils import is_valid_email
...
from beak.apps.user.entities import (
    Group,
    Permission,
    User,
    UserPreference,
...
from beak.apps.user.repository import (
    GroupRepository,
    PermissionRepository,
    UserPreferenceRepository,
    UserRepository,
)
from beak.apps.user.schemas import (
    GroupCreate,
    GroupUpdate,
    PermissionCreate,
    PermissionUpdate,
