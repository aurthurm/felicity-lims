...
from beak.apps.abstract import BaseEntity
from beak.apps.setup.entities import District, Province
from beak.apps.user.abstract import AbstractBaseUser
from beak.apps.user.enum import UserType
