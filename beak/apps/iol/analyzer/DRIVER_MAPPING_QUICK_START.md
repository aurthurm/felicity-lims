...
**Estimated**: 2-4 hours
**Files**: `beak/api/gql/instrument/` queries and mutations
...
**File**: `beak/apps/iol/analyzer/services/transformer.py`
...
**See**: `beak/apps/iol/analyzer/services/transformer.py`
