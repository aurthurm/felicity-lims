...
```python
# In beak/api/gql/instrument/query.py
...
```python
# beak/api/gql/instrument/query.py
...
The Vue.js frontend provides an intuitive visual interface for creating driver mappings without any coding. The workflow
is straightforward:
...
All driver generation and persistence is handled by the frontend and backend working together, enabling users to easily
configure new instruments.
