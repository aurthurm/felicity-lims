...
from beak.utils.hipaa_fields import EncryptedPHIType, EncryptedPIIType
...
def upgrade():
    ...
    op.create_index(
        "idx_date_age_range",
        "date_search_index",
        ["field_name", "age_range_hash"],
        unique=False,
    )
    op.create_index(
        "idx_date_full", "date_search_index", ["field_name", "date_hash"], unique=False
    )
    op.create_index(
        "idx_date_month",
        "date_search_index",
        ["field_name", "month_hash"],
        unique=False,
    )
    op.create_index(
        "idx_date_year", "date_search_index", ["field_name", "year_hash"], unique=False
    )
    op.create_index(
        op.f("ix_date_search_index_age_range_hash"),
        "date_search_index",
        ["age_range_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_date_search_index_date_hash"),
        "date_search_index",
        ["date_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_date_search_index_day_hash"),
        "date_search_index",
        ["day_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_date_search_index_month_hash"),
        "date_search_index",
        ["month_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_date_search_index_uid"), "date_search_index", ["uid"], unique=False
    )
    op.create_index(
        op.f("ix_date_search_index_year_hash"),
        "date_search_index",
        ["year_hash"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_patient_field_hash",
        "patient_search_index",
        ["field_name", "search_hash"],
        unique=False,
    )
    op.create_index(
        "idx_patient_partial_3",
        "patient_search_index",
        ["field_name", "partial_hash_3"],
        unique=False,
    )
    op.create_index(
        "idx_patient_partial_4",
        "patient_search_index",
        ["field_name", "partial_hash_4"],
        unique=False,
    )
    op.create_index(
        "idx_patient_partial_5",
        "patient_search_index",
        ["field_name", "partial_hash_5"],
        unique=False,
    )
    op.create_index(
        "idx_patient_phonetic",
        "patient_search_index",
        ["field_name", "phonetic_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_patient_search_index_partial_hash_3"),
        "patient_search_index",
        ["partial_hash_3"],
        unique=False,
    )
    op.create_index(
        op.f("ix_patient_search_index_partial_hash_4"),
        "patient_search_index",
        ["partial_hash_4"],
        unique=False,
    )
    op.create_index(
        op.f("ix_patient_search_index_partial_hash_5"),
        "patient_search_index",
        ["partial_hash_5"],
        unique=False,
    )
    op.create_index(
        op.f("ix_patient_search_index_phonetic_hash"),
        "patient_search_index",
        ["phonetic_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_patient_search_index_search_hash"),
        "patient_search_index",
        ["search_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_patient_search_index_uid"),
        "patient_search_index",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_phone_area_code",
        "phone_search_index",
        ["field_name", "area_code_hash"],
        unique=False,
    )
    op.create_index(
        "idx_phone_last_four",
        "phone_search_index",
        ["field_name", "last_four_hash"],
        unique=False,
    )
    op.create_index(
        "idx_phone_normalized",
        "phone_search_index",
        ["field_name", "normalized_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phone_search_index_area_code_hash"),
        "phone_search_index",
        ["area_code_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phone_search_index_last_four_hash"),
        "phone_search_index",
        ["last_four_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phone_search_index_normalized_hash"),
        "phone_search_index",
        ["normalized_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phone_search_index_uid"), "phone_search_index", ["uid"], unique=False
    )
    op.alter_column(
        "analysis_result",
        "result",
    ...
    op.drop_index(
        "ix_patient_identification_value", table_name="patient_identification"
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        "ix_patient_identification_value",
    ...
    op.drop_index(
        op.f("ix_phone_search_index_normalized_hash"), table_name="phone_search_index"
    )
    op.drop_index(
        op.f("ix_phone_search_index_last_four_hash"), table_name="phone_search_index"
    )
    op.drop_index(
        op.f("ix_phone_search_index_area_code_hash"), table_name="phone_search_index"
    )
    ...
    op.drop_index(
        op.f("ix_patient_search_index_uid"), table_name="patient_search_index"
    )
    op.drop_index(
        op.f("ix_patient_search_index_search_hash"), table_name="patient_search_index"
    )
    op.drop_index(
        op.f("ix_patient_search_index_phonetic_hash"), table_name="patient_search_index"
    )
    op.drop_index(
        op.f("ix_patient_search_index_partial_hash_5"),
        table_name="patient_search_index",
    )
    op.drop_index(
        op.f("ix_patient_search_index_partial_hash_4"),
        table_name="patient_search_index",
    ...
    op.drop_index(
        op.f("ix_date_search_index_year_hash"), table_name="date_search_index"
    )
    op.drop_index(op.f("ix_date_search_index_uid"), table_name="date_search_index")
    op.drop_index(
        op.f("ix_date_search_index_month_hash"), table_name="date_search_index"
    )
    op.drop_index(op.f("ix_date_search_index_day_hash"), table_name="date_search_index")
    op.drop_index(
        op.f("ix_date_search_index_date_hash"), table_name="date_search_index"
    )
    op.drop_index(
        op.f("ix_date_search_index_age_range_hash"), table_name="date_search_index"
    )
