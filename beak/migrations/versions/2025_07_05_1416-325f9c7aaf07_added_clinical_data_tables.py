...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "other_context", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_clinical_data_uid"), "clinical_data", ["uid"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_clinical_data_coding_uid"),
        "clinical_data_coding",
        ["uid"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_clinical_data_coding_uid"), table_name="clinical_data_coding"
    )
