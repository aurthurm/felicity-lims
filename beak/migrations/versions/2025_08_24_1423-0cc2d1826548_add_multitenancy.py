...
def upgrade():
    ...
    op.create_index(
        op.f("ix_organization_setting_uid"),
        "organization_setting",
        ["uid"],
        unique=False,
    )
    op.add_column(
        "abx_ast_panel", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_abx_ast_panel_laboratory_uid"),
        "abx_ast_panel",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "abx_ast_panel", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "abx_ast_result", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_abx_ast_result_laboratory_uid"),
        "abx_ast_result",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "abx_ast_result", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "abx_organism_result", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_abx_organism_result_laboratory_uid"),
        "abx_organism_result",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "abx_organism_result", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "activity_feed", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_activity_feed_laboratory_uid"),
        "activity_feed",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "activity_feed", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "activity_stream", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_activity_stream_laboratory_uid"),
        "activity_stream",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "activity_stream", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "analysis_discount", sa.Column("laboratory_uid", sa.String(), nullable=True)
    )
    op.create_index(
        op.f("ix_analysis_discount_laboratory_uid"),
        "analysis_discount",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "analysis_discount", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "analysis_price", sa.Column("laboratory_uid", sa.String(), nullable=True)
    )
    op.create_index(
        op.f("ix_analysis_price_laboratory_uid"),
        "analysis_price",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "analysis_price", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "analysis_request", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_analysis_request_laboratory_uid"),
        "analysis_request",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "analysis_request", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "analysis_result", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_analysis_result_laboratory_uid"),
        "analysis_result",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "analysis_result", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "analysis_template", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_analysis_template_laboratory_uid"),
        "analysis_template",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "analysis_template", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "analysis_uncertainty", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_analysis_uncertainty_laboratory_uid"),
        "analysis_uncertainty",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "analysis_uncertainty", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "app_activity_logs", sa.Column("user_uid", sa.String(length=39), nullable=True)
    )
    op.add_column(
        "app_activity_logs",
        sa.Column("request_id", sa.String(length=39), nullable=True),
    )
    op.add_column(
        "app_activity_logs",
        sa.Column("laboratory_uid", sa.String(length=39), nullable=True),
    )
    op.add_column(
        "app_activity_logs",
        sa.Column("organization_uid", sa.String(length=39), nullable=True),
    )
    op.add_column(
        "audit_log",
    ...
    op.create_index(
        op.f("ix_calibration_certificate_laboratory_uid"),
        "calibration_certificate",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "calibration_certificate", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "clinical_data", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_clinical_data_laboratory_uid"),
        "clinical_data",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "clinical_data", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "clinical_data_coding", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_clinical_data_coding_laboratory_uid"),
        "clinical_data_coding",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "clinical_data_coding", "laboratory", ["laboratory_uid"], ["uid"]
    )
    ...
    op.create_index(
        op.f("ix_document_laboratory_uid"), "document", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "document", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "document_audit", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_audit_laboratory_uid"),
        "document_audit",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_audit", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_category", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_category_laboratory_uid"),
        "document_category",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_category", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_folder", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_folder_laboratory_uid"),
        "document_folder",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_folder", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_review_cycle",
        sa.Column("laboratory_uid", sa.String(), nullable=False),
    )
    op.create_index(
        op.f("ix_document_review_cycle_laboratory_uid"),
        "document_review_cycle",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_review_cycle", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_review_step", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_review_step_laboratory_uid"),
        "document_review_step",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_review_step", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_status", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_status_laboratory_uid"),
        "document_status",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_status", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
    ...
    op.create_index(
        op.f("ix_document_subscription_laboratory_uid"),
        "document_subscription",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_subscription", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_tag", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_tag_laboratory_uid"),
        "document_tag",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_tag", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_template", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_template_laboratory_uid"),
        "document_template",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_template", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "document_version", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_document_version_laboratory_uid"),
        "document_version",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "document_version", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_board", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_board_laboratory_uid"),
        "grind_board",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_board", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_errand", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_errand_laboratory_uid"),
        "grind_errand",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_errand", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_errand_discussion",
        sa.Column("laboratory_uid", sa.String(), nullable=False),
    )
    op.create_index(
        op.f("ix_grind_errand_discussion_laboratory_uid"),
        "grind_errand_discussion",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_errand_discussion", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_label", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_label_laboratory_uid"),
        "grind_label",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_label", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_media", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_media_laboratory_uid"),
        "grind_media",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_media", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_milestone", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_milestone_laboratory_uid"),
        "grind_milestone",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_milestone", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_occurrence", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_occurrence_laboratory_uid"),
        "grind_occurrence",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_occurrence", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_poster", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_poster_laboratory_uid"),
        "grind_poster",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_poster", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_scheme", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_scheme_laboratory_uid"),
        "grind_scheme",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_scheme", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "grind_stamp", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_grind_stamp_laboratory_uid"),
        "grind_stamp",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "grind_stamp", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("group", sa.Column("laboratory_uid", sa.String(), nullable=True))
    op.create_index(
        op.f("ix_group_laboratory_uid"), "group", ["laboratory_uid"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_instrument_calibration_laboratory_uid"),
        "instrument_calibration",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "instrument_calibration", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
    ...
    op.create_index(
        op.f("ix_instrument_competence_laboratory_uid"),
        "instrument_competence",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "instrument_competence", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "laboratory", sa.Column("organization_uid", sa.String(), nullable=False)
    )
    ...
    op.create_foreign_key(
        None, "laboratory", "organization", ["organization_uid"], ["uid"]
    )
    op.drop_column("laboratory", "lab_name")
    op.drop_column("laboratory", "setup_name")
    op.add_column(
        "laboratory_instrument", sa.Column("laboratory_uid", sa.String(), nullable=True)
    )
    op.create_index(
        op.f("ix_laboratory_instrument_laboratory_uid"),
        "laboratory_instrument",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "laboratory_instrument", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.alter_column(
        "laboratory_setting",
        "laboratory_uid",
    ...
    op.create_index(
        op.f("ix_laboratory_setting_laboratory_uid"),
        "laboratory_setting",
        ["laboratory_uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_message_laboratory_uid"), "message", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "message", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "message_thread", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_message_thread_laboratory_uid"),
        "message_thread",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "message_thread", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("notice", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_notice_laboratory_uid"), "notice", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "notice", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "notification", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_notification_laboratory_uid"),
        "notification",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "notification", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("patient", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_patient_laboratory_uid"), "patient", ["laboratory_uid"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_patient_identification_laboratory_uid"),
        "patient_identification",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "patient_identification", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("profile", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_profile_laboratory_uid"), "profile", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "profile", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "profile_coding", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_profile_coding_laboratory_uid"),
        "profile_coding",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "profile_coding", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "profile_discount", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_profile_discount_laboratory_uid"),
        "profile_discount",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "profile_discount", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "profile_price", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_profile_price_laboratory_uid"),
        "profile_price",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "profile_price", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("qc_level", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_qc_level_laboratory_uid"), "qc_level", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "qc_level", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "qc_reference", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_qc_reference_laboratory_uid"),
        "qc_reference",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "qc_reference", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("qc_set", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_qc_set_laboratory_uid"), "qc_set", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "qc_set", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "qc_template", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_qc_template_laboratory_uid"),
        "qc_template",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "qc_template", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "referral_laboratory", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_referral_laboratory_laboratory_uid"),
        "referral_laboratory",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "referral_laboratory", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "report_meta", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_report_meta_laboratory_uid"),
        "report_meta",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "report_meta", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "result_mutation", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_result_mutation_laboratory_uid"),
        "result_mutation",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "result_mutation", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("sample", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_sample_laboratory_uid"), "sample", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "sample", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "shipped_sample", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_shipped_sample_laboratory_uid"),
        "shipped_sample",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "shipped_sample", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "stock_adjustment", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_stock_adjustment_laboratory_uid"),
        "stock_adjustment",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "stock_adjustment", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "stock_order", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_stock_order_laboratory_uid"),
        "stock_order",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "stock_order", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "stock_order_product", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_stock_order_product_laboratory_uid"),
        "stock_order_product",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "stock_order_product", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "stock_product_inventory",
        sa.Column("laboratory_uid", sa.String(), nullable=False),
    )
    op.create_index(
        op.f("ix_stock_product_inventory_laboratory_uid"),
        "stock_product_inventory",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "stock_product_inventory", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "stock_receipt", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_stock_receipt_laboratory_uid"),
        "stock_receipt",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "stock_receipt", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("test_bill", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_test_bill_laboratory_uid"),
        "test_bill",
        ["laboratory_uid"],
        unique=False,
    )
    ...
    op.add_column(
        "test_bill_invoice", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_test_bill_invoice_laboratory_uid"),
        "test_bill_invoice",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "test_bill_invoice", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "test_bill_transaction",
        sa.Column("laboratory_uid", sa.String(), nullable=False),
    )
    op.create_index(
        op.f("ix_test_bill_transaction_laboratory_uid"),
        "test_bill_transaction",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "test_bill_transaction", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "user", sa.Column("active_laboratory_uid", sa.String(), nullable=True)
    )
    op.create_foreign_key(
        None, "user", "laboratory", ["active_laboratory_uid"], ["uid"]
    )
    op.add_column(
        "user_preference", sa.Column("laboratory_uid", sa.String(), nullable=True)
    )
    op.create_index(
        op.f("ix_user_preference_laboratory_uid"),
        "user_preference",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "user_preference", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("voucher", sa.Column("laboratory_uid", sa.String(), nullable=True))
    op.create_index(
        op.f("ix_voucher_laboratory_uid"), "voucher", ["laboratory_uid"], unique=False
    )
    op.create_foreign_key(None, "voucher", "laboratory", ["laboratory_uid"], ["uid"])
    op.add_column(
        "voucher_code", sa.Column("laboratory_uid", sa.String(), nullable=True)
    )
    op.create_index(
        op.f("ix_voucher_code_laboratory_uid"),
        "voucher_code",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "voucher_code", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column(
        "voucher_customer", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_voucher_customer_laboratory_uid"),
        "voucher_customer",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "voucher_customer", "laboratory", ["laboratory_uid"], ["uid"]
    )
    op.add_column("worksheet", sa.Column("laboratory_uid", sa.String(), nullable=False))
    op.create_index(
        op.f("ix_worksheet_laboratory_uid"),
        "worksheet",
        ["laboratory_uid"],
        unique=False,
    )
    ...
    op.add_column(
        "worksheet_template", sa.Column("laboratory_uid", sa.String(), nullable=False)
    )
    op.create_index(
        op.f("ix_worksheet_template_laboratory_uid"),
        "worksheet_template",
        ["laboratory_uid"],
        unique=False,
    )
    op.create_foreign_key(
        None, "worksheet_template", "laboratory", ["laboratory_uid"], ["uid"]
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_worksheet_template_laboratory_uid"), table_name="worksheet_template"
    )
    ...
    op.drop_index(
        op.f("ix_voucher_customer_laboratory_uid"), table_name="voucher_customer"
    )
    ...
    op.drop_index(
        op.f("ix_user_preference_laboratory_uid"), table_name="user_preference"
    )
    ...
    op.drop_index(
        op.f("ix_stock_adjustment_laboratory_uid"), table_name="stock_adjustment"
    )
    ...
    op.drop_index(
        op.f("ix_result_mutation_laboratory_uid"), table_name="result_mutation"
    )
    ...
    op.drop_index(
        op.f("ix_referral_laboratory_laboratory_uid"), table_name="referral_laboratory"
    )
    ...
    op.drop_index(
        op.f("ix_profile_discount_laboratory_uid"), table_name="profile_discount"
    )
    ...
    op.drop_index(
        op.f("ix_patient_identification_laboratory_uid"),
        table_name="patient_identification",
    )
    ...
    op.drop_index(
        op.f("ix_laboratory_setting_laboratory_uid"), table_name="laboratory_setting"
    )
    op.alter_column(
        "laboratory_setting",
        "laboratory_uid",
    ...
    op.drop_index(
        op.f("ix_laboratory_instrument_laboratory_uid"),
        table_name="laboratory_instrument",
    )
    op.drop_column("laboratory_instrument", "laboratory_uid")
    op.add_column(
        "laboratory",
        sa.Column("setup_name", sa.VARCHAR(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "laboratory",
        sa.Column("lab_name", sa.VARCHAR(), autoincrement=False, nullable=False),
    )
    ...
    op.drop_index(
        op.f("ix_grind_occurrence_laboratory_uid"), table_name="grind_occurrence"
    )
    op.drop_column("grind_occurrence", "laboratory_uid")
    op.drop_constraint(None, "grind_milestone", type_="foreignkey")
    op.drop_index(
        op.f("ix_grind_milestone_laboratory_uid"), table_name="grind_milestone"
    )
    ...
    op.drop_index(
        op.f("ix_grind_errand_discussion_laboratory_uid"),
        table_name="grind_errand_discussion",
    )
    ...
    op.drop_index(
        op.f("ix_document_version_laboratory_uid"), table_name="document_version"
    )
    op.drop_column("document_version", "laboratory_uid")
    op.drop_constraint(None, "document_template", type_="foreignkey")
    op.drop_index(
        op.f("ix_document_template_laboratory_uid"), table_name="document_template"
    )
    ...
    op.drop_index(
        op.f("ix_clinical_data_coding_laboratory_uid"),
        table_name="clinical_data_coding",
    )
    ...
    op.drop_index(
        op.f("ix_calibration_certificate_laboratory_uid"),
        table_name="calibration_certificate",
    )
    ...
    op.drop_index(
        op.f("ix_analysis_discount_laboratory_uid"), table_name="analysis_discount"
    )
    op.drop_column("analysis_discount", "laboratory_uid")
    op.drop_constraint(None, "activity_stream", type_="foreignkey")
    op.drop_index(
        op.f("ix_activity_stream_laboratory_uid"), table_name="activity_stream"
    )
    ...
    op.drop_index(
        op.f("ix_abx_organism_result_laboratory_uid"), table_name="abx_organism_result"
    )
    ...
    op.drop_index(
        op.f("ix_organization_setting_uid"), table_name="organization_setting"
    )
