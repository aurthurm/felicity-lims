import{a0 as g,ac as x,h as u,a7 as f,ad as h,_ as w,c,o as p,A as n,L as k,J as v,K as D}from"./index-DCVfsbos.js";import{u as S}from"./samples-BrAyCdA1.js";import"./analyses.mutations-BEU63HnJ.js";import"./storage.mutations-CYc-ciRc.js";const b="40mm 30mm",B=g({name:"BarcodePrintView",__name:"index",setup(y,{expose:e}){e();const l=x(),{barcodeSamples:s}=S(),d=u(()=>{if(window.history.state.sampleUids)return JSON.parse(window.history.state.sampleUids);const t=JSON.parse(l.query.sampleUids?.toString()??"");return Array.isArray(t)?t:t?.split(",")}),i=f(2),a=(t=!0)=>{if(t)i.value++;else{if(i.value===1)return;i.value--}},r=f([]);h(async()=>{r.value=await s(d.value)});const _=u(()=>r.value.flatMap(t=>Array(i.value).fill(t))),m={route:l,barcodeSamples:s,sampleUids:d,multiplier:i,increment:a,originalData:r,barcodes:_,imgData:t=>`data:application/png;base64,${t}`,printDimensions:b,printBarcodes:()=>{const t=document.getElementById("printZoneOuter").innerHTML,o=window.open("","_blank");o&&(o.document.open(),o.document.write(`
      <html>
        <head>
