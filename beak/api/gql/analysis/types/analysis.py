...
from beak.api.gql.client.types import ClientType, ClientContactType
from beak.api.gql.instrument.types import InstrumentType, MethodType
from beak.api.gql.patient.types import PatientType
