...
from beak.api.gql.analysis.types.analysis import SampleType
...
class StorageMutations:
    @strawberry.mutation(
        extensions=[
            PermissionExtension(
                permissions=[
                    IsAuthenticated(),
                    HasPermission(FAction.CREATE, FObject.STORAGE),
                ]
            )
        ]
    )
    ...
    @strawberry.mutation(
        extensions=[
            PermissionExtension(
                permissions=[
                    IsAuthenticated(),
                    HasPermission(FAction.UPDATE, FObject.STORAGE),
                ]
            )
        ]
    )
    async def update_store_room(
        ...
        setattr(store_room, "updated_by_uid", beak_user.uid)
    ...
    async def update_storage_location(
        ...
        setattr(storage_location, "updated_by_uid", beak_user.uid)
    ...
    async def update_storage_section(
        ...
        setattr(storage_section, "updated_by_uid", beak_user.uid)
    ...
    async def update_storage_container(
        ...
        setattr(storage_container, "updated_by_uid", beak_user.uid)
    ...
    @strawberry.mutation(
        extensions=[
            PermissionExtension(
                permissions=[
                    IsAuthenticated(),
                    HasPermission(FAction.STORE, FObject.SAMPLE),
                ]
            )
        ]
    )
