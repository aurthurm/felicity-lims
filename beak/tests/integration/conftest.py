...
from beak.lims.seeds.groups_perms import seed_groups_perms
from beak.lims.seeds.superusers import seed_super_user
from beak.main import beak
from beak.tests.integration.utils.user import extract_auth, auth_user_mutation
...
async def app_root() -> AsyncGenerator[AsyncClient, Any]:
    transport = ASGITransport(app=beak)
