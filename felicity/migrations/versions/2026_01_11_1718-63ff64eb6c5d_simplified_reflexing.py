...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['laboratory_uid'], ['laboratory.uid'], name='fk_reflex_trigger_laboratory'),
    ...
    sa.ForeignKeyConstraint(['laboratory_uid'], ['laboratory.uid'], name='fk_reflex_decision_laboratory'),
    ...
    op.create_index(op.f('ix_reflex_decision_reflex_trigger_uid'), 'reflex_decision', ['reflex_trigger_uid'], unique=False)
    ...
    sa.ForeignKeyConstraint(['laboratory_uid'], ['laboratory.uid'], name='fk_reflex_add_analysis_laboratory'),
    ...
    op.create_index(op.f('ix_reflex_add_analysis_laboratory_uid'), 'reflex_add_analysis', ['laboratory_uid'], unique=False)
    op.create_index(op.f('ix_reflex_add_analysis_reflex_decision_uid'), 'reflex_add_analysis', ['reflex_decision_uid'], unique=False)
    ...
    sa.Column('updated_by_uid', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['analysis_uid'], ['analysis.uid'], ),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name='fk_reflex_finalize_analysis_created_by'),
    sa.ForeignKeyConstraint(['laboratory_uid'], ['laboratory.uid'], name='fk_reflex_finalize_analysis_laboratory'),
    sa.ForeignKeyConstraint(['reflex_decision_uid'], ['reflex_decision.uid'], ),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name='fk_reflex_finalize_analysis_updated_by'),
    sa.PrimaryKeyConstraint('uid')
    )
    op.create_index(op.f('ix_reflex_finalize_analysis_laboratory_uid'), 'reflex_finalize_analysis', ['laboratory_uid'], unique=False)
    op.create_index(op.f('ix_reflex_finalize_analysis_reflex_decision_uid'), 'reflex_finalize_analysis', ['reflex_decision_uid'], unique=False)
    ...
    sa.ForeignKeyConstraint(['laboratory_uid'], ['laboratory.uid'], name='fk_reflex_rule_group_laboratory'),
    sa.ForeignKeyConstraint(['reflex_decision_uid'], ['reflex_decision.uid'], ),
    ...
    op.create_index(op.f('ix_reflex_rule_group_reflex_decision_uid'), 'reflex_rule_group', ['reflex_decision_uid'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by_uid', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name='fk_reflex_decision_execution_created_by'),
    sa.ForeignKeyConstraint(['reflex_decision_uid'], ['reflex_decision.uid'], ),
    sa.ForeignKeyConstraint(['sample_uid'], ['sample.uid'], ),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name='fk_reflex_decision_execution_updated_by'),
    sa.PrimaryKeyConstraint('uid'),
    sa.UniqueConstraint('sample_uid', 'reflex_decision_uid', name='uq_reflex_decision_execution_sample_decision')
    )
    op.create_index(op.f('ix_reflex_decision_execution_reflex_decision_uid'), 'reflex_decision_execution', ['reflex_decision_uid'], unique=False)
    op.create_index(op.f('ix_reflex_decision_execution_sample_uid'), 'reflex_decision_execution', ['sample_uid'], unique=False)
    ...
    sa.Column('updated_by_uid', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['analysis_uid'], ['analysis.uid'], ),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name='fk_reflex_rule_criteria_created_by'),
    sa.ForeignKeyConstraint(['laboratory_uid'], ['laboratory.uid'], name='fk_reflex_rule_criteria_laboratory'),
    sa.ForeignKeyConstraint(['reflex_rule_group_uid'], ['reflex_rule_group.uid'], ),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name='fk_reflex_rule_criteria_updated_by'),
    sa.PrimaryKeyConstraint('uid')
    )
    op.create_index(op.f('ix_reflex_rule_criteria_laboratory_uid'), 'reflex_rule_criteria', ['laboratory_uid'], unique=False)
    op.create_index(op.f('ix_reflex_rule_criteria_reflex_rule_group_uid'), 'reflex_rule_criteria', ['reflex_rule_group_uid'], unique=False)
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name='reflex_brain_condition_created_by_uid_fkey'),
    sa.ForeignKeyConstraint(['reflex_brain_uid'], ['reflex_brain.uid'], name='reflex_brain_condition_reflex_brain_uid_fkey'),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name='reflex_brain_condition_updated_by_uid_fkey'),
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_by_uid', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['analysis_uid'], ['analysis.uid'], name=op.f('reflex_brain_condition_criteria_analysis_uid_fkey')),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name=op.f('reflex_brain_condition_criteria_created_by_uid_fkey')),
    sa.ForeignKeyConstraint(['reflex_brain_condition_uid'], ['reflex_brain_condition.uid'], name=op.f('reflex_brain_condition_criteria_reflex_brain_condition_uid_fkey')),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name=op.f('reflex_brain_condition_criteria_updated_by_uid_fkey')),
    sa.PrimaryKeyConstraint('analysis_uid', 'reflex_brain_condition_uid', 'uid', name=op.f('reflex_brain_condition_criteria_pkey'))
    )
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_by_uid', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['analysis_uid'], ['analysis.uid'], name=op.f('reflex_brain_final_analysis_uid_fkey')),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name=op.f('reflex_brain_final_created_by_uid_fkey')),
    sa.ForeignKeyConstraint(['reflex_brain_action_uid'], ['reflex_brain_action.uid'], name=op.f('reflex_brain_final_reflex_brain_action_uid_fkey')),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name=op.f('reflex_brain_final_updated_by_uid_fkey'))
    )
    ...
    sa.ForeignKeyConstraint(['reflex_rule_uid'], ['reflex_rule.uid'], name='reflex_action_reflex_rule_uid_fkey'),
    sa.ForeignKeyConstraint(['sample_type_uid'], ['sample_type.uid'], name='reflex_action_sample_type_uid_fkey'),
    ...
    sa.ForeignKeyConstraint(['analysis_uid'], ['analysis.uid'], name=op.f('reflex_action_analysis_analysis_uid_fkey')),
    sa.ForeignKeyConstraint(['reflex_action_uid'], ['reflex_action.uid'], name=op.f('reflex_action_analysis_reflex_action_uid_fkey')),
    sa.PrimaryKeyConstraint('analysis_uid', 'reflex_action_uid', name=op.f('reflex_action_analysis_pkey'))
    )
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_by_uid', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['analysis_uid'], ['analysis.uid'], name=op.f('reflex_brain_addition_analysis_uid_fkey')),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name=op.f('reflex_brain_addition_created_by_uid_fkey')),
    sa.ForeignKeyConstraint(['reflex_brain_action_uid'], ['reflex_brain_action.uid'], name=op.f('reflex_brain_addition_reflex_brain_action_uid_fkey')),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name=op.f('reflex_brain_addition_updated_by_uid_fkey'))
    )
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated_by_uid', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name=op.f('reflex_brain_action_created_by_uid_fkey')),
    sa.ForeignKeyConstraint(['reflex_brain_uid'], ['reflex_brain.uid'], name=op.f('reflex_brain_action_reflex_brain_uid_fkey')),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name=op.f('reflex_brain_action_updated_by_uid_fkey')),
    ...
    sa.Column('updated_by_uid', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('priority', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['created_by_uid'], ['user.uid'], name=op.f('reflex_brain_created_by_uid_fkey')),
    sa.ForeignKeyConstraint(['reflex_action_uid'], ['reflex_action.uid'], name=op.f('reflex_brain_reflex_action_uid_fkey')),
    sa.ForeignKeyConstraint(['updated_by_uid'], ['user.uid'], name=op.f('reflex_brain_updated_by_uid_fkey')),
