...
def upgrade():
    ...
    op.create_index(
        op.f("ix_abx_antibiotic_uid"), "abx_antibiotic", ["uid"], unique=False
    )
    op.create_table(
        "abx_ast_panel",
    ...
    op.create_index(
        op.f("ix_abx_ast_panel_uid"), "abx_ast_panel", ["uid"], unique=False
    )
    op.create_table(
        "abx_breakpoint_type",
        sa.Column("name", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_abx_breakpoint_type_uid"), "abx_breakpoint_type", ["uid"], unique=False
    )
    op.create_table(
        "abx_expert_interpret_rule",
    ...
    op.create_index(
        op.f("ix_abx_expert_interpret_rule_uid"),
        "abx_expert_interpret_rule",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_abx_guideline_uid"), "abx_guideline", ["uid"], unique=False
    )
    op.create_table(
        "abx_host",
        sa.Column("name", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_abx_infection_site_uid"), "abx_infection_site", ["uid"], unique=False
    )
    op.create_table(
        "abx_kingdom",
        sa.Column("name", sa.String(length=100), nullable=False),
    ...
    op.create_index(
        op.f("ix_abx_test_method_uid"), "abx_test_method", ["uid"], unique=False
    )
    op.create_table(
        "app_activity_logs",
    ...
    op.create_index(
        op.f("ix_app_activity_logs_uid"), "app_activity_logs", ["uid"], unique=False
    )
    op.create_table(
        "document_category",
        sa.Column("name", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_document_category_uid"), "document_category", ["uid"], unique=False
    )
    op.create_table(
        "document_folder",
        sa.Column("name", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_document_folder_uid"), "document_folder", ["uid"], unique=False
    )
    op.create_table(
        "document_tag",
        sa.Column("name", sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "target",
            sa.Enum("ERRAND", "MILESTONE", name="occurrencetarget"),
            nullable=True,
        ),
        sa.Column("target_uid", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_grind_occurrence_uid"), "grind_occurrence", ["uid"], unique=False
    )
    op.create_table(
        "grind_scheme",
        sa.Column("title", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum("PROJECT", "TICKET", name="stampcategory"),
            nullable=True,
        ),
        sa.Column("uid", sa.String(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_abx_antibiotic_guideline_uid"),
        "abx_antibiotic_guideline",
        ["uid"],
        unique=False,
    )
    op.create_table(
        "abx_expected_res_phenotype",
    ...
    op.create_index(
        op.f("ix_abx_expected_res_phenotype_uid"),
        "abx_expected_res_phenotype",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_abx_guideline_year_uid"), "abx_guideline_year", ["uid"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_abx_qc_ranges_uid"), "abx_qc_ranges", ["uid"], unique=False
    )
    op.create_table(
        "document_template",
        sa.Column("name", sa.String(), nullable=True),
    ...
    op.create_index(
        op.f("ix_document_template_uid"), "document_template", ["uid"], unique=False
    )
    op.create_table(
        "grind_board",
        sa.Column("title", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["site_of_infection_uid"],
            ["abx_infection_site.uid"],
        ),
        sa.ForeignKeyConstraint(
            ["test_method_uid"],
            ["abx_test_method.uid"],
    ...
    op.create_index(
        op.f("ix_abx_breakpoint_uid"), "abx_breakpoint", ["uid"], unique=False
    )
    op.create_table(
        "abx_class",
        sa.Column("name", sa.String(length=100), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["last_accessed_by_uid"],
            ["user.uid"],
        ),
        sa.ForeignKeyConstraint(
            ["template_uid"],
            ["document_template.uid"],
        ),
        sa.ForeignKeyConstraint(
            ["updated_by_uid"],
            ["user.uid"],
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum("LISTING", "ENGAGEMENT", "TODO", "MESSAGE", name="postercategory"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_document_audit_uid"), "document_audit", ["uid"], unique=False
    )
    op.create_table(
        "document_author",
    ...
    op.create_index(
        op.f("ix_document_review_cycle_uid"),
        "document_review_cycle",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_document_status_uid"), "document_status", ["uid"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_document_subscription_uid"),
        "document_subscription",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_document_version_uid"), "document_version", ["uid"], unique=False
    )
    op.create_table(
        "grind_errand",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_document_review_step_uid"),
        "document_review_step",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_grind_errand_discussion_uid"),
        "grind_errand_discussion",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_grind_milestone_uid"), "grind_milestone", ["uid"], unique=False
    )
    op.create_table(
        "abx_genus",
        sa.Column("name", sa.String(length=100), nullable=False),
    ...
    op.create_index(
        op.f("ix_abx_organism_serotypes_uid"),
        "abx_organism_serotypes",
        ["uid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_abx_organism_result_uid"), "abx_organism_result", ["uid"], unique=False
    )
    op.create_table(
        "abx_ast_result",
    ...
    op.create_index(
        op.f("ix_abx_ast_result_uid"), "abx_ast_result", ["uid"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_analysis_result_level"), "analysis_result", ["level"], unique=False
    )
    op.create_index(
        op.f("ix_analysis_result_lft"), "analysis_result", ["lft"], unique=False
    )
    op.create_index(
        op.f("ix_analysis_result_rgt"), "analysis_result", ["rgt"], unique=False
    )
...
def downgrade():
    ...
    op.create_index(
        "analysis_result_level_idx", "analysis_result", ["level"], unique=False
    )
    ...
    op.drop_index(
        op.f("ix_abx_organism_serotypes_uid"), table_name="abx_organism_serotypes"
    )
    ...
    op.drop_index(
        op.f("ix_grind_errand_discussion_uid"), table_name="grind_errand_discussion"
    )
    op.drop_table("grind_errand_discussion")
    op.drop_index(
        op.f("ix_document_review_step_uid"), table_name="document_review_step"
    )
    ...
    op.drop_index(
        op.f("ix_document_subscription_uid"), table_name="document_subscription"
    )
    ...
    op.drop_index(
        op.f("ix_document_review_cycle_uid"), table_name="document_review_cycle"
    )
    ...
    op.drop_index(
        op.f("ix_abx_expected_res_phenotype_uid"),
        table_name="abx_expected_res_phenotype",
    )
    op.drop_table("abx_expected_res_phenotype")
    op.drop_index(
        op.f("ix_abx_antibiotic_guideline_uid"), table_name="abx_antibiotic_guideline"
    )
    ...
    op.drop_index(
        op.f("ix_abx_expert_interpret_rule_uid"), table_name="abx_expert_interpret_rule"
    )
