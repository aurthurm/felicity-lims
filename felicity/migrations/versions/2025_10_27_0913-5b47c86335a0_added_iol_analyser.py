...
def upgrade():
    ...
    op.create_table('instrument_interface',
    ...
    op.create_index(op.f('ix_instrument_interface_laboratory_uid'), 'instrument_interface', ['laboratory_uid'], unique=False)
    op.create_index(op.f('ix_instrument_interface_uid'), 'instrument_interface', ['uid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_instrument_interface_uid'), table_name='instrument_interface')
    op.drop_index(op.f('ix_instrument_interface_laboratory_uid'), table_name='instrument_interface')
