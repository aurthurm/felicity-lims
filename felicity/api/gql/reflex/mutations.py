...
from felicity.api.gql.types.generic import DeletedItem, DeleteResponse
...
from felicity.apps.reflex.entities import ReflexDecision, ReflexTrigger
...
class ReflexRuleMutations:
    ...
    async def _sync_reflex_trigger_analyses(
        ...
        from felicity.apps.reflex.entities import reflex_trigger_analysis
    ...
    async def update_reflex_decision(
        ...
        async with ReflexDecisionService().transaction() as session:
            ...
            setattr(decision, "updated_by_uid", felicity_user.uid)
