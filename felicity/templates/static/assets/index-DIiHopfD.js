import{a0 as g,ac as x,h as m,a7 as f,ad as h,_ as w,c as p,o as c,A as n,L as D,J as v,K as S}from"./index-CNAOKjig.js";import{u as k}from"./samples-DqZBjYU6.js";import"./analyses.mutations-BhfuTbLn.js";import"./storage.mutations-CFO7fcBK.js";const y="40mm 30mm",B=g({__name:"index",setup(b,{expose:e}){e();const l=x(),{barcodeSamples:o}=k(),d=m(()=>{if(window.history.state.sampleUids)return JSON.parse(window.history.state.sampleUids);const t=JSON.parse(l.query.sampleUids?.toString()??"");return Array.isArray(t)?t:t?.split(",")}),s=f(2),a=(t=!0)=>{if(t)s.value++;else{if(s.value===1)return;s.value--}},r=f([]);h(async()=>{r.value=await o(d.value)});const _=m(()=>r.value.flatMap(t=>Array(s.value).fill(t))),u={route:l,barcodeSamples:o,sampleUids:d,multiplier:s,increment:a,originalData:r,barcodes:_,imgData:t=>`data:application/png;base64,${t}`,printDimensions:y,printBarcodes:()=>{const t=document.getElementById("printZoneOuter").innerHTML,i=window.open("","_blank");i&&(i.document.open(),i.document.write(`
      <html>
        <head>
