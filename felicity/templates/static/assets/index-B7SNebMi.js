import{a0 as g,ac as x,h as u,a7 as f,ad as h,_ as w,c as p,o as c,A as n,L as k,J as b,K as D}from"./index-Daoe3XS9.js";import{u as S}from"./samples-jAQEtyo4.js";import"./analyses.mutations-DmiK7cfK.js";import"./storage.mutations-BG-DUju8.js";const v="40mm 30mm",B=g({__name:"index",setup(y,{expose:e}){e();const l=x(),{barcodeSamples:s}=S(),d=u(()=>{if(window.history.state.sampleUids)return JSON.parse(window.history.state.sampleUids);const t=JSON.parse(l.query.sampleUids?.toString()??"");return Array.isArray(t)?t:t?.split(",")}),o=f(2),a=(t=!0)=>{if(t)o.value++;else{if(o.value===1)return;o.value--}},r=f([]);h(async()=>{r.value=await s(d.value)});const _=u(()=>r.value.flatMap(t=>Array(o.value).fill(t))),m={route:l,barcodeSamples:s,sampleUids:d,multiplier:o,increment:a,originalData:r,barcodes:_,imgData:t=>`data:application/png;base64,${t}`,printDimensions:v,printBarcodes:()=>{const t=document.getElementById("printZoneOuter").innerHTML,i=window.open("","_blank");i&&(i.document.open(),i.document.write(`
      <html>
        <head>
