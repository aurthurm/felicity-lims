import{bS as B,g as u,d as L,u as q,f as r,a0 as A,an as $,bT as p}from"./index-OdhKCqIc.js";var m={exports:{}},x=m.exports,O;function I(){return O||(O=1,(function(a,w){(function(l,f){a.exports=f()})(x,(function(){var l="month",f="quarter";return function(b,g){var i=g.prototype;i.quarter=function(s){return this.$utils().u(s)?Math.ceil((this.month()+1)/3):this.month(this.month()%3+3*(s-1))};var S=i.add;i.add=function(s,c){return s=Number(s),this.$utils().p(c)===f?this.add(3*s,l):S.bind(this)(s,c)};var h=i.startOf;i.startOf=function(s,c){var y=this.$utils(),v=!!y.u(c)||c;if(y.p(s)===f){var d=this.quarter()-1;return v?this.month(3*d).startOf(l).startOf("day"):this.month(3*d+2).endOf(l).endOf("day")}return h.bind(this)(s,c)}}}))})(m)),m.exports}var R=I();const W=B(R),Y=u`
